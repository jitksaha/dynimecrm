...
export const Logo = ({
  ...
  const defaultPrimaryLogoUrl = `${window.location.origin}/images/dynime/dynime-icon.png`;
  ...
  const isDuplicateSecondary =
    secondaryLogoUrl === primaryLogoUrl ||
    (isUsingDefaultLogo && (secondaryLogoUrl?.includes('dynime') || !secondaryLogoUrl));
  ...
  return (
    <StyledContainer onClick={() => onClick?.()}>
      ...
      {!isDuplicateSecondary && isDefined(secondaryLogoUrl) ? (
