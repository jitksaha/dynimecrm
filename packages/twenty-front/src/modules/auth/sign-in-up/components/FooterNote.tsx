...
export const FooterNote = ({
  ...
  if (!isOnAWorkspace) {
    return (
      <StyledCopyContainer>
        <div>
          <Trans>By using DCRM, you agree to the</Trans>{' '}
          <a
            href="https://dynime.com/terms"
            target="_blank"
        ...
        <StyledPoweredBy>Powered by Dynime LLC</StyledPoweredBy>
      </StyledCopyContainer>
    );
  }
  ...
  return (
    <div>
      ...
      <StyledPoweredBy style={{ textAlign: 'center' }}>
        Powered by Dynime LLC
      </StyledPoweredBy>
    </div>
  );
};
