...
import { checkIfItsABrowserExtensionError } from '@/error-handler/utils/checkIfItsABrowserExtensionError';
...
export const PromiseRejectionEffect = () => {
  ...
  const handlePromiseRejection = useCallback(
    async (event: PromiseRejectionEvent) => {
      ...
      const isBrowserExtensionError = checkIfItsABrowserExtensionError(error);
