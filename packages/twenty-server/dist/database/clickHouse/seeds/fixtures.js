...
const _objectrecordcreated = require("../../../engine/core-modules/event-logs/emit/events/object-event/object-record-created");
const _objectrecorddelete = require("../../../engine/core-modules/event-logs/emit/events/object-event/object-record-delete");
const _objectrecordupdated = require("../../../engine/core-modules/event-logs/emit/events/object-event/object-record-updated");
const _customdomainactivated = require("../../../engine/core-modules/event-logs/emit/events/workspace-event/custom-domain/custom-domain-activated");
const _customdomaindeactivated = require("../../../engine/core-modules/event-logs/emit/events/workspace-event/custom-domain/custom-domain-deactivated");
const _formatdatetimeforclickhouseutil = require("../utils/format-date-time-for-clickhouse.util");
        ...
        for(let userIdx = 0; userIdx < users.length; userIdx++){
            ...
            for (const op of operations){
                ...
                for(let eventIdx = 0; eventIdx < eventsCount; eventIdx++){
                    ...
                    fixtures.push({
                        timestamp: (0, _formatdatetimeforclickhouseutil.formatDateTimeForClickHouse)(eventDate),
                        workspaceId: _seederworkspacesconstant.SEED_APPLE_WORKSPACE_ID,
                        periodStart: (0, _formatdatetimeforclickhouseutil.formatDateTimeForClickHouse)(new Date(Date.UTC(eventDate.getUTCFullYear(), eventDate.getUTCMonth(), 1))),
