...
let MigrateMessagingInfrastructureToMetadataCommand = class MigrateMessagingInfrastructureToMetadataCommand extends _provisionedworkspacecommandrunner.ProvisionedWorkspaceCommandRunner {
    async runOnWorkspace({ workspaceId, options }) {
        ...
        const connectedAccountWorkspaceRepository = this.workspaceOrmManager.getRepository('connectedAccount');
        const messageChannelWorkspaceRepository = this.workspaceOrmManager.getRepository('messageChannel');
        const calendarChannelWorkspaceRepository = this.workspaceOrmManager.getRepository('calendarChannel');
        const messageFolderWorkspaceRepository = this.workspaceOrmManager.getRepository('messageFolder');
    ...
    constructor(workspaceOrmManager, connectedAccountRepository, messageChannelRepository, calendarChannelRepository, messageFolderRepository, userWorkspaceRepository, featureFlagService, workspaceIteratorService){
        super(workspaceIteratorService), this.workspaceOrmManager = workspaceOrmManager, this.connectedAccountRepository = connectedAccountRepository, this.messageChannelRepository = messageChannelRepository, this.calendarChannelRepository = calendarChannelRepository, this.messageFolderRepository = messageFolderRepository, this.userWorkspaceRepository = userWorkspaceRepository, this.featureFlagService = featureFlagService, this.workspaceIteratorService = workspaceIteratorService;
    }
};
