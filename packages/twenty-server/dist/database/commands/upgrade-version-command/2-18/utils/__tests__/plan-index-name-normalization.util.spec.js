...
const _planindexnamenormalizationutil = require("../plan-index-name-normalization.util");
...
describe('planIndexNameNormalization', ()=>{
    it('returns no operations for an empty input', ()=>{
        expect((0, _planindexnamenormalizationutil.planIndexNameNormalization)([])).toEqual([]);
    });
    it('returns no operations when every index name already matches', ()=>{
        ...
        expect((0, _planindexnamenormalizationutil.planIndexNameNormalization)(statuses)).toEqual([]);
    });
    ...
    it('handles a mix of correct, legacy, and duplicate indexes across objects', ()=>{
        ...
        const operations = (0, _planindexnamenormalizationutil.planIndexNameNormalization)(statuses);
...
//# sourceMappingURL=plan-index-name-normalization.util.spec.js.map