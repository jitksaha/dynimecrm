...
const STANDARD_OBJECT_UNIVERSAL_IDENTIFIER = '20202020-0000-4000-8000-0000000000bb';
const CUSTOM_OBJECT_UNIVERSAL_IDENTIFIER = '20202020-0000-4000-8000-0000000000bc';
const FIELD_UNIVERSAL_IDENTIFIER = '20202020-0000-4000-8000-0000000000cc';
const DERIVED_STANDARD_VIEW_UNIVERSAL_IDENTIFIER = (0, _application.getSystemViewUniversalIdentifier)({
...
const DERIVED_STANDARD_VIEW_FIELD_UNIVERSAL_IDENTIFIER = (0, _application.getSystemViewFieldUniversalIdentifier)({
...
const EXTERNAL_OBJECT_UNIVERSAL_IDENTIFIER = '20202020-0000-4000-8000-0000000000bd';
...
const buildFlatViewField = (viewField)=>({
        applicationUniversalIdentifier: STANDARD_APPLICATION_UNIVERSAL_IDENTIFIER,
        fieldMetadataUniversalIdentifier: FIELD_UNIVERSAL_IDENTIFIER,
        deletedAt: null,
        isSystemSideEffect: false,
...
const buildFlatFieldMetadata = ({ applicationUniversalIdentifier = STANDARD_APPLICATION_UNIVERSAL_IDENTIFIER } = {})=>({
...
describe('ReconcileIndexViewUniversalIdentifierCommand', ()=>{
    ...
    beforeEach(()=>{
        ...
        const entityManagerMock = {
            getRepository: (entity)=>{
                if (entity === _viewentity.ViewEntity) {
                    return {
                        update: viewUpdateMock
                    };
                }
                if (entity === _viewfieldentity.ViewFieldEntity) {
                    return {
                        update: viewFieldUpdateMock
                    };
                }
        ...
        command = new _226workspacecommand1785255689000reconcileindexviewuniversalidentifiercommand.ReconcileIndexViewUniversalIdentifierCommand({}, {
    ...
    const mockWorkspaceCache = ({ views, viewFields = [], fieldMetadatas = [
    ...
    it('re-owns an underived standard INDEX view and its view fields', async ()=>{
        ...
        expect(invalidateCacheMock.mock.calls[0][0].allFlatEntityMapsKeys).toEqual(expect.arrayContaining([
            'flatViewMaps',
            'flatViewFieldMaps',
    ...
    it('re-owns a custom object INDEX view onto the workspace-custom derivation', async ()=>{
        const derivedCustomViewUniversalIdentifier = (0, _application.getSystemViewUniversalIdentifier)({
    ...
    it('re-owns an external application view field living on a standard INDEX view', async ()=>{
        ...
        const derivedExternalViewFieldUniversalIdentifier = (0, _application.getSystemViewFieldUniversalIdentifier)({
...
//# sourceMappingURL=2-26-workspace-command-1785255689000-reconcile-index-view-universal-identifier.command.spec.js.map