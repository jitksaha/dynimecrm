...
const _computecallrecordingtabpositionutil = require("../compute-call-recording-tab-position.util");
...
describe('computeCallRecordingTabPosition', ()=>{
    it('places the tab directly after Home when Home is the last tab', ()=>{
        expect((0, _computecallrecordingtabpositionutil.computeCallRecordingTabPosition)({
...
//# sourceMappingURL=compute-call-recording-tab-position.util.spec.js.map