...
Object.defineProperty(exports, "EraseObjectNavigationCommandMenuItemPayloadsSlowInstanceCommand", {
    enumerable: true,
    get: function() {
        return EraseObjectNavigationCommandMenuItemPayloadsSlowInstanceCommand;
    }
});
...
let EraseObjectNavigationCommandMenuItemPayloadsSlowInstanceCommand = class EraseObjectNavigationCommandMenuItemPayloadsSlowInstanceCommand {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "core"."commandMenuItem" ADD CONSTRAINT "${ENGINE_KEY_COHERENCE_CHECK_NAME}" CHECK (${EXCLUSIVE_ENGINE_KEY_COHERENCE_CHECK})`);
    }
    async down(queryRunner) {
      ...
      WHERE "engineComponentKey" = 'NAVIGATION'
        ...
        AND "payload" IS NULL
    `);
        await queryRunner.query(`ALTER TABLE "core"."commandMenuItem" ADD CONSTRAINT "${ENGINE_KEY_COHERENCE_CHECK_NAME}" CHECK (${RELAXED_ENGINE_KEY_COHERENCE_CHECK})`);
    }
};
EraseObjectNavigationCommandMenuItemPayloadsSlowInstanceCommand = _ts_decorate([
    (0, _registeredinstancecommanddecorator.RegisteredInstanceCommand)('2.38.0', 1788272351971, {
        type: 'slow'
    })
], EraseObjectNavigationCommandMenuItemPayloadsSlowInstanceCommand);

//# sourceMappingURL=2-38-instance-command-slow-1788272351971-erase-object-navigation-command-menu-item-payloads.js.map