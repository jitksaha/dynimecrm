...
const prepareForOrderByRelationFieldParsing = ({ orderByArg, fieldMetadata, flatObjectMetadataMaps, flatFieldMetadataMaps, groupByFields })=>{
    ...
    const canOrderByFunctionallyDependentNestedField = !(0, _ismorphorrelationflatfieldmetadatautil.isMorphOrRelationFlatFieldMetadata)(nestedFieldMetadata);
    const groupByFieldOnTargetPrimaryKey = !(0, _utils.isDefined)(exactGroupByFieldMatch) && canOrderByFunctionallyDependentNestedField ? groupByFields.find((groupByField)=>(0, _isgroupbyrelationfieldutil.isGroupByRelationField)(groupByField) && groupByField.fieldMetadata.id === fieldMetadata.id && groupByField.nestedFieldMetadata.name === 'id') : undefined;
    const associatedGroupByField = exactGroupByFieldMatch ?? groupByFieldOnTargetPrimaryKey;
    ...
    return {
        ...
        isMatchedOnTargetPrimaryKeyGroupBy: !(0, _utils.isDefined)(exactGroupByFieldMatch)
    };
};
