...
let GraphqlQuerySelectedFieldsParser = class GraphqlQuerySelectedFieldsParser {
    parse(// oxlint-disable-next-line typescript/no-explicit-any
    ...
    parseRecordFields(// oxlint-disable-next-line typescript/no-explicit-any
    ...
    parseConnectionField(// oxlint-disable-next-line typescript/no-explicit-any
    graphqlSelectedFields, flatObjectMetadata, accumulator, isFromOneToManyRelation) {
        this.aggregateParser.parse(graphqlSelectedFields, flatObjectMetadata, this.flatFieldMetadataMaps, accumulator);
    ...
    isRootConnection(// oxlint-disable-next-line typescript/no-explicit-any
    graphqlSelectedFields) {
        return Object.keys(graphqlSelectedFields).includes('edges');
    }
    parseCompositeField(fieldMetadata, // oxlint-disable-next-line typescript/no-explicit-any
    fieldValue) {
