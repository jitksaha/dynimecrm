...
const _defaultmergefieldvalueutil = require("../default-merge-field-value.util");
describe('defaultMergeFieldValue', ()=>{
    it('should return priority record value when available', ()=>{
        ...
        const result = (0, _defaultmergefieldvalueutil.defaultMergeFieldValue)(recordsWithValues, '1');
    ...
    it('should return null when no records exist', ()=>{
        const result = (0, _defaultmergefieldvalueutil.defaultMergeFieldValue)([], '1');
...
//# sourceMappingURL=default-merge-field-value.util.spec.js.map