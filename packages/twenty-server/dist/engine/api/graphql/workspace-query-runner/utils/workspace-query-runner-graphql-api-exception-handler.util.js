...
const _usagelimittographqlapiexceptionhandlerutil = require("../../../../core-modules/usage-limit/utils/usage-limit-to-graphql-api-exception-handler.util");
...
const workspaceQueryRunnerGraphqlApiExceptionHandler = (error)=>{
    switch(true){
        ...
        case error instanceof _usagelimitexception.UsageLimitException:
            return (0, _usagelimittographqlapiexceptionhandlerutil.usageLimitToGraphqlApiExceptionHandler)(error);
