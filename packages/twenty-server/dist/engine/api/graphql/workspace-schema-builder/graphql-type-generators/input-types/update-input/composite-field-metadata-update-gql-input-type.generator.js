...
let CompositeFieldMetadataUpdateGqlInputTypeGenerator = class CompositeFieldMetadataUpdateGqlInputTypeGenerator {
    ...
    generateFields(compositeType) {
        ...
        for (const property of compositeType.properties){
            ...
            const type = compositeSubFieldGqlTypes?.input ?? ((0, _isenumfieldmetadatatypeutil.isEnumFieldMetadataType)(property.type) ? this.gqlTypesStorage.getGqlTypeByKey(key) : this.typeMapperService.mapToPreBuiltGraphQLInputType({
