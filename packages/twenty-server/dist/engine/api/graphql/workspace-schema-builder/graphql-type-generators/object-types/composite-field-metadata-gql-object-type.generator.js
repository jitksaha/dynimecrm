...
const _getcompositesubfieldgqltypesutil = require("../../utils/get-composite-sub-field-gql-types.util");
...
let CompositeFieldMetadataGqlObjectTypeGenerator = class CompositeFieldMetadataGqlObjectTypeGenerator {
    ...
    generateFields(compositeType) {
        ...
        for (const property of compositeType.properties){
            ...
            const compositeSubFieldGqlTypes = (0, _getcompositesubfieldgqltypesutil.getCompositeSubFieldGqlTypes)(compositeType.type, property.name);
            const type = compositeSubFieldGqlTypes?.output ?? ((0, _isenumfieldmetadatatypeutil.isEnumFieldMetadataType)(property.type) ? this.gqlTypesStorage.getGqlTypeByKey(key) : this.typeMapperService.mapToPreBuiltGraphQLOutputType({
