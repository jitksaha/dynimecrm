...
const _writesseeventutil = require("../write-sse-event.util");
...
describe('writeSseEvent', ()=>{
    it('should write correctly formatted SSE event', ()=>{
        ...
        (0, _writesseeventutil.writeSseEvent)(mockResponse, data);
    ...
    it('should set content-type headers when headers have not been sent', ()=>{
        ...
        (0, _writesseeventutil.writeSseEvent)(mockResponse, {
            jsonrpc: '2.0',
            id: '1',
            result: {}
        });
...
//# sourceMappingURL=write-sse-event.util.spec.js.map