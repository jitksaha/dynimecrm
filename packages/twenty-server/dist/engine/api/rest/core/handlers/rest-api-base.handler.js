...
let RestApiBaseHandler = class RestApiBaseHandler {
    ...
    async buildCommonOptions(request) {
        ...
        const { flatObjectMetadata, flatObjectMetadataMaps, flatFieldMetadataMaps, flatIndexMaps, objectIdByNameSingular } = await this.getObjectMetadata(request, parsedObject);
    ...
    async getObjectMetadata(request, parsedObject) {
        ...
        const { flatObjectMetadataMaps, flatFieldMetadataMapsOrm: flatFieldMetadataMaps, flatIndexMaps } = await this.workspaceManyOrAllFlatEntityMapsCacheService.getOrRecomputeManyOrAllFlatEntityMaps({
