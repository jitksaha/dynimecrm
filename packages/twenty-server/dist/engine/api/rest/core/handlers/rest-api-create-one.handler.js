...
let RestApiCreateOneHandler = class RestApiCreateOneHandler extends _restapibasehandler.RestApiBaseHandler {
    async handle(request) {
        try {
            ...
            const { authContext, flatObjectMetadata, flatObjectMetadataMaps, flatFieldMetadataMaps, flatIndexMaps, objectIdByNameSingular } = await this.buildCommonOptions(request);
