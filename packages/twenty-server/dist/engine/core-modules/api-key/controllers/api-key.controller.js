...
const _ismetadatarestrequestutil = require("../../../api/rest/metadata/utils/is-metadata-rest-request.util");
...
let ApiKeyController = class ApiKeyController {
    async findAll(request, workspace) {
        const apiKeys = await this.apiKeyService.findActiveByWorkspaceId(workspace.id);
        return (0, _ismetadatarestrequestutil.isMetadataRestRequest)(request) ? (0, _paginatemetadatarestitemsutil.paginateMetadataRestItems)({
            items: apiKeys,
            request
        }) : apiKeys;
    }
...
_ts_decorate([
    (0, _common.UseGuards)(_requireaccesstokenguard.RequireAccessTokenGuard),
    (0, _common.Post)(),
...
ApiKeyController = _ts_decorate([
    (0, _common.Controller)([
        `${_types.ApiPath.Rest}/apiKeys`,
        `${_types.ApiPath.Rest}/metadata/apiKeys`
    ]),
