...
var AppTokenType = /*#__PURE__*/ function(AppTokenType) {
    ...
    AppTokenType["OnboardingInvitationToken"] = "ONBOARDING_INVITATION_TOKEN";
    ...
    AppTokenType["SSOExchangeToken"] = "SSO_EXCHANGE_TOKEN";
    return AppTokenType;
}({});
...
AppTokenEntity = _ts_decorate([
    ...
    (0, _typeorm.Index)('IDX_APP_TOKEN_TYPE_VALUE_SSO_EXCHANGE_UNIQUE', [
        'type',
        'value'
    ], {
        unique: true,
