...
describe('fromConnectionProviderManifestToUniversalFlatConnectionProvider', ()=>{
    ...
    it('resolves the onConnectLogicFunction universalIdentifier into the flat field when provided', ()=>{
        const onConnectLogicFunctionUniversalIdentifier = 'c1c1c1c1-c1c1-4c1c-c1c1-c1c1c1c1c1c1';
        const result = (0, _fromconnectionprovidermanifesttouniversalflatconnectionproviderutil.fromConnectionProviderManifestToUniversalFlatConnectionProvider)({
            connectionProviderManifest: buildManifest({
        ...
        expect(result.onConnectLogicFunctionUniversalIdentifier).toBe(onConnectLogicFunctionUniversalIdentifier);
    });
    it('resolves the onDisconnectLogicFunction universalIdentifier into the flat field when provided', ()=>{
        const onDisconnectLogicFunctionUniversalIdentifier = 'd2d2d2d2-d2d2-4d2d-d2d2-d2d2d2d2d2d2';
        const result = (0, _fromconnectionprovidermanifesttouniversalflatconnectionproviderutil.fromConnectionProviderManifestToUniversalFlatConnectionProvider)({
            connectionProviderManifest: buildManifest({
        ...
        expect(result.onDisconnectLogicFunctionUniversalIdentifier).toBe(onDisconnectLogicFunctionUniversalIdentifier);
    });
