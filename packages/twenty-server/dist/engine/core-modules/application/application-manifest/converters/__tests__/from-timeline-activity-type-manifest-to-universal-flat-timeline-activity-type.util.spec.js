...
const _fromtimelineactivitytypemanifesttouniversalflattimelineactivitytypeutil = require("../from-timeline-activity-type-manifest-to-universal-flat-timeline-activity-type.util");
...
const REPLACED_TYPE_UNIVERSAL_IDENTIFIER = '66666666-6666-4666-8666-666666666666';
...
describe('fromTimelineActivityTypeManifestToUniversalFlatTimelineActivityType', ()=>{
    it('normalizes nested emit routing into flat metadata', ()=>{
        expect((0, _fromtimelineactivitytypemanifesttouniversalflattimelineactivitytypeutil.fromTimelineActivityTypeManifestToUniversalFlatTimelineActivityType)({
    ...
    it('maps the public replacement identifier to internal metadata', ()=>{
        expect((0, _fromtimelineactivitytypemanifesttouniversalflattimelineactivitytypeutil.fromTimelineActivityTypeManifestToUniversalFlatTimelineActivityType)({
            ...
            timelineActivityTypeManifest: {
                ...
                replacesTimelineActivityTypeUniversalIdentifier: REPLACED_TYPE_UNIVERSAL_IDENTIFIER
            }
        })).toMatchObject({
            replacesTimelineActivityTypeUniversalIdentifier: REPLACED_TYPE_UNIVERSAL_IDENTIFIER
        });
...
//# sourceMappingURL=from-timeline-activity-type-manifest-to-universal-flat-timeline-activity-type.util.spec.js.map