...
const fromFrontComponentManifestToUniversalFlatFrontComponent = ({ frontComponentManifest, applicationUniversalIdentifier, isSettingsFrontComponent, now })=>{
    return {
        ...
        isHeadless: isSettingsFrontComponent ? false : frontComponentManifest.isHeadless ?? false,
