...
const _marketplacecatalogcacheproviderservice = require("./marketplace-catalog-cache-provider.service");
const _marketplacecatalogsyncservice = require("./marketplace-catalog-sync.service");
const _marketplacepublicresolver = require("./marketplace-public.resolver");
...
MarketplaceModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            ...
            _marketplacecatalogcacheproviderservice.MarketplaceCatalogCacheProviderService,
            ...
            _marketplacepublicresolver.MarketplacePublicResolver
        ],
        exports: [
            _marketplacecatalogsyncservice.MarketplaceCatalogSyncService,
            _marketplacequeryservice.MarketplaceQueryService,
