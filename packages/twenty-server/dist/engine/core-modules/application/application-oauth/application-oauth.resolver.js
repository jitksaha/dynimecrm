...
const _generateapplicationtokeninput = require("../application-development/dtos/generate-application-token.input");
...
let ApplicationOAuthResolver = class ApplicationOAuthResolver {
    async generateApplicationToken({ applicationId }, { id: workspaceId }, user, userWorkspaceId) {
        await this.throttlerService.tokenBucketThrottleOrThrow(`app-dev:${workspaceId}:${applicationId}`, 1, APP_TOKEN_RATE_LIMIT_MAX, APP_TOKEN_RATE_LIMIT_WINDOW_MS);
    ...
    constructor(applicationTokenService, throttlerService){
...
], ApplicationOAuthResolver.prototype, "generateApplicationToken", null);
_ts_decorate([
    (0, _graphql.Mutation)(()=>_applicationtokenpairdto.ApplicationTokenPairDTO),
...
ApplicationOAuthResolver = _ts_decorate([
    ...
    (0, _common.UseFilters)(_applicationexceptionfilter.ApplicationExceptionFilter, _authgraphqlapiexceptionfilter.AuthGraphqlApiExceptionFilter, _throttlergraphqlapiexceptionfilter.ThrottlerGraphqlApiExceptionFilter),
