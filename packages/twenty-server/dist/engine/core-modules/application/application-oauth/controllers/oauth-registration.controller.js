...
let OAuthRegistrationController = class OAuthRegistrationController {
    async register(body, req, res) {
        ...
        return {
            ...
            registration_client_uri: `${issuer}/${_types.ApiPath.OAuth}/register/${clientId}`
        };
    }
    ...
    async readRegistration(clientId, req, res) {
        ...
        return {
            ...
            registration_client_uri: `${issuer}/${_types.ApiPath.OAuth}/register/${registration.oAuthClientId}`
        };
    }
...
OAuthRegistrationController = _ts_decorate([
    (0, _common.Controller)(_types.ApiPath.OAuth),
