...
const _applicationregistrationclaiminput = require("./dtos/application-registration-claim.input");
const _applicationregistrationstatsdto = require("./dtos/application-registration-stats.dto");
const _claimapplicationregistrationownershipinput = require("./dtos/claim-application-registration-ownership.input");
const _claimableapplicationregistrationdto = require("./dtos/claimable-application-registration.dto");
const _findclaimableapplicationregistrationinput = require("./dtos/find-claimable-application-registration.input");
...
let ApplicationRegistrationResolver = class ApplicationRegistrationResolver {
    ...
    async findClaimableApplicationRegistration({ sourcePackage, universalIdentifier }) {
        return this.applicationRegistrationService.findClaimable({
            sourcePackage,
            universalIdentifier
        });
    }
    async claimApplicationRegistrationOwnership({ applicationRegistrationId }, { id: workspaceId }) {
        return this.applicationRegistrationService.claimOwnership({
            applicationRegistrationId,
            claimingWorkspaceId: workspaceId
        });
    }
    async githubClaimAuthorizationUrl({ applicationRegistrationId }, { id: workspaceId }, user) {
    ...
    constructor(applicationRegistrationService, applicationRegistrationClaimService, applicationRegistrationVariableService, applicationTarballService, applicationRegistrationAssetUrlService, fileUrlService, twentyConfigService){
...
_ts_decorate([
    ...
    (0, _graphql.Query)(()=>_claimableapplicationregistrationdto.ClaimableApplicationRegistrationDTO, {
        nullable: true
    }),
    _ts_param(0, (0, _graphql.Args)()),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _findclaimableapplicationregistrationinput.FindClaimableApplicationRegistrationInput === "undefined" ? Object : _findclaimableapplicationregistrationinput.FindClaimableApplicationRegistrationInput
    ]),
    _ts_metadata("design:returntype", Promise)
], ApplicationRegistrationResolver.prototype, "findClaimableApplicationRegistration", null);
_ts_decorate([
    (0, _common.UseGuards)(_workspaceauthguard.WorkspaceAuthGuard, _adminpanelguard.AdminPanelGuard, (0, _settingspermissionguard.SettingsPermissionGuard)(_constants.PermissionFlagType.APPLICATIONS)),
    (0, _graphql.Mutation)(()=>_applicationregistrationentity.ApplicationRegistrationEntity),
    _ts_param(0, (0, _graphql.Args)()),
    _ts_param(1, (0, _authworkspacedecorator.AuthWorkspace)()),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _claimapplicationregistrationownershipinput.ClaimApplicationRegistrationOwnershipInput === "undefined" ? Object : _claimapplicationregistrationownershipinput.ClaimApplicationRegistrationOwnershipInput,
        typeof _workspaceentity.WorkspaceEntity === "undefined" ? Object : _workspaceentity.WorkspaceEntity
    ]),
    _ts_metadata("design:returntype", Promise)
], ApplicationRegistrationResolver.prototype, "claimApplicationRegistrationOwnership", null);
_ts_decorate([
    (0, _common.UseGuards)(_workspaceauthguard.WorkspaceAuthGuard, (0, _settingspermissionguard.SettingsPermissionGuard)(_constants.PermissionFlagType.APPLICATIONS)),
    (0, _graphql.Query)(()=>String),
    _ts_param(0, (0, _graphql.Args)()),
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _applicationregistrationclaiminput.ApplicationRegistrationClaimInput === "undefined" ? Object : _applicationregistrationclaiminput.ApplicationRegistrationClaimInput,
        typeof _workspaceentity.WorkspaceEntity === "undefined" ? Object : _workspaceentity.WorkspaceEntity,
        Object
    ]),
    _ts_metadata("design:returntype", Promise)
], ApplicationRegistrationResolver.prototype, "githubClaimAuthorizationUrl", null);
_ts_decorate([
    (0, _common.UseGuards)(_workspaceauthguard.WorkspaceAuthGuard, (0, _settingspermissionguard.SettingsPermissionGuard)(_constants.PermissionFlagType.APPLICATIONS)),
    (0, _graphql.Mutation)(()=>_applicationregistrationentity.ApplicationRegistrationEntity),
    _ts_param(0, (0, _graphql.Args)()),
...
], ApplicationRegistrationResolver.prototype, "logoUrl", null);
_ts_decorate([
...
], ApplicationRegistrationResolver.prototype, "galleryImagesUrls", null);
