...
_ts_decorate([
    ...
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.19.0_AddLogoFileIdToApplicationFastInstanceCommand_1783062755137'
    }),
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "logoFileId", void 0);
_ts_decorate([
    ...
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "logoFile", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true,
        type: 'text'
...
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: false,
        type: 'text',
        default: _applicationstateenum.ApplicationState.INSTALLED
    }),
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.38.0_AddStateToApplicationFastInstanceCommand_1788260646460'
    }),
    _ts_metadata("design:type", typeof _applicationstateenum.ApplicationState === "undefined" ? Object : _applicationstateenum.ApplicationState)
], ApplicationEntity.prototype, "state", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: false,
        type: 'text'
...
_ts_decorate([
    ...
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.32.0_AddUninstallLogicFunctionIdToApplicationFastInstanceCommand_1786959731000'
    }),
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "uninstallLogicFunctionId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true,
        type: 'timestamptz'
    ...
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.33.0_AddUninstallHookCompletedForRequestedAtToApplicationFastInstanceCommand_1787151824000'
    }),
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "uninstallHookCompletedForRequestedAt", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: false,
        type: 'boolean',
...
_ts_decorate([
    ...
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.23.0_AddAutoUpgradeToApplicationFastInstanceCommand_1784297307235'
    }),
    _ts_metadata("design:type", Boolean)
], ApplicationEntity.prototype, "autoUpgrade", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: false,
        type: 'boolean',
...
_ts_decorate([
    ...
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.23.0_AddSdkClientCoreChecksumToApplicationFastInstanceCommand_1784625638000'
    }),
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "sdkClientCoreChecksum", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true,
        type: 'text'
    ...
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.31.0_AddFrontComponentSharedDependenciesToApplicationFastInstanceCommand_1786529082690'
    }),
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "frontComponentSharedDependenciesChecksum", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true,
        type: 'text'
    ...
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "frontComponentSharedDependenciesBuiltPath", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true,
        type: 'uuid'
...
_ts_decorate([
    ...
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.16.0_AddPrimaryPublicDomainToApplicationFastInstanceCommand_1782281874768'
    }),
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "primaryPublicDomainId", void 0);
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_publicdomainentity.PublicDomainEntity, {
        onDelete: 'SET NULL',
        nullable: true
    }),
    (0, _typeorm.JoinColumn)({
        name: 'primaryPublicDomainId'
    }),
    _ts_metadata("design:type", Object)
], ApplicationEntity.prototype, "primaryPublicDomain", void 0);
_ts_decorate([
    (0, _typeorm.OneToMany)(()=>_publicdomainentity.PublicDomainEntity, (publicDomain)=>publicDomain.application, {
        onDelete: 'SET NULL'
    }),
    _ts_metadata("design:type", typeof Relation === "undefined" ? Object : Relation)
], ApplicationEntity.prototype, "publicDomains", void 0);
_ts_decorate([
