...
let MicrosoftAPIsAuthController = class MicrosoftAPIsAuthController {
    ...
    async MicrosoftAuthGetAccessToken(req, res) {
        ...
        try {
            ...
            const { pathname, searchParams, hash } = (0, _parserelativeurlutil.parseRelativeUrl)(redirectLocation || (0, _utils.getSettingsPath)(_types.SettingsPath.AccountsConfiguration, {
                connectedAccountId
            }));
...
MicrosoftAPIsAuthController = _ts_decorate([
    (0, _common.Controller)(`${_types.ApiPath.Auth}/microsoft-apis`),
