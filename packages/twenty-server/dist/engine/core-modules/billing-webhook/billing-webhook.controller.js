...
let BillingWebhookController = class BillingWebhookController {
    ...
    async handleStripeEvent(event) {
        switch(event.type){
            ...
            case _billingwebhookeventsenum.BillingWebhookEvent.PAYMENT_METHOD_ATTACHED:
            case _billingwebhookeventsenum.BillingWebhookEvent.PAYMENT_METHOD_DETACHED:
                return await this.billingWebhookCustomerService.processStripeEvent(event);
...
_ts_decorate([
    (0, _common.Post)(`${_types.ApiPath.Webhooks}/stripe`),
