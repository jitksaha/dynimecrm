...
const _billingpaymentintentdto = require("./dtos/billing-payment-intent.dto");
...
let BillingResolver = class BillingResolver {
    async billingPortalSession(workspace, { returnUrlPath, forPaymentMethodUpdate }) {
        return {
            url: await this.billingPortalWorkspaceService.computeBillingPortalSessionURLOrThrow(workspace, returnUrlPath, forPaymentMethodUpdate)
        };
    }
    ...
    async createSubscriptionPaymentIntent(workspace, user, userWorkspaceId, { recurringInterval, plan }, idempotencyKey, apiKey) {
        await this.validateCanCheckoutSessionPermissionOrThrow({
            workspaceId: workspace.id,
            userWorkspaceId,
            apiKeyId: apiKey?.id,
        ...
        const resolvedPlan = plan ?? _billingplankeyenum.BillingPlanKey.PRO;
        const billingPricesPerPlan = await this.billingPlanService.getPricesPerPlanByInterval({
    ...
    async createBillingPaymentMethodSetupIntent(workspace) {
        return this.billingPortalWorkspaceService.createPaymentMethodSetupIntent(workspace);
    }
...
_ts_decorate([
    (0, _graphql.Mutation)(()=>_billingpaymentintentdto.BillingPaymentIntentDTO),
    (0, _common.UseGuards)(_workspaceauthguard.WorkspaceAuthGuard, _userauthguard.UserAuthGuard, _nopermissionguard.NoPermissionGuard),
    _ts_param(0, (0, _authworkspacedecorator.AuthWorkspace)()),
    _ts_param(1, (0, _authuserdecorator.AuthUser)()),
    _ts_param(2, (0, _authuserworkspaceiddecorator.AuthUserWorkspaceId)()),
    _ts_param(3, (0, _graphql.Args)()),
    _ts_param(4, (0, _graphql.Args)('idempotencyKey', {
        type: ()=>String
    })),
    ...
    _ts_metadata("design:returntype", Promise)
], BillingResolver.prototype, "createSubscriptionPaymentIntent", null);
_ts_decorate([
    (0, _graphql.Mutation)(()=>_billingpaymentintentdto.BillingPaymentIntentDTO),
    (0, _common.UseGuards)(_workspaceauthguard.WorkspaceAuthGuard, (0, _settingspermissionguard.SettingsPermissionGuard)(_constants.PermissionFlagType.BILLING)),
    _ts_param(0, (0, _authworkspacedecorator.AuthWorkspace)()),
    ...
    _ts_metadata("design:returntype", Promise)
], BillingResolver.prototype, "createBillingPaymentMethodSetupIntent", null);
_ts_decorate([
