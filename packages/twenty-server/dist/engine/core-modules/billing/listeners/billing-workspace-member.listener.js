...
const _updatesubscriptionquantityjobdelaymsconstant = require("../constants/update-subscription-quantity-job-delay-ms.constant");
...
let BillingWorkspaceMemberListener = class BillingWorkspaceMemberListener {
    async handleCreateOrDeleteEvent(payload) {
        ...
        await this.messageQueueService.add(_updatesubscriptionquantityjob.UpdateSubscriptionQuantityJob.name, {
            ...
            delay: _updatesubscriptionquantityjobdelaymsconstant.UPDATE_SUBSCRIPTION_QUANTITY_JOB_DELAY_MS
        });
    }
