...
const _notendedsubscriptionstatusesconstant = require("../../constants/not-ended-subscription-statuses.constant");
...
let StripeSubscriptionScheduleService = class StripeSubscriptionScheduleService {
    ...
    async listCustomerNotEndedSubscriptionsWithSchedule(stripeCustomerId) {
        ...
        return subscriptions.filter((subscription)=>_notendedsubscriptionstatusesconstant.NOT_ENDED_SUBSCRIPTION_STATUSES.includes(subscription.status));
    }
