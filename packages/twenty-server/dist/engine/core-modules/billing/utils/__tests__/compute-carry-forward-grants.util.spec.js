...
const _computecarryforwardgrantsutil = require("../compute-carry-forward-grants.util");
...
describe('computeCarryForwardGrants', ()=>{
    describe('plan allowance', ()=>{
        it('rolls the unspent allowance over', ()=>{
            const result = (0, _computecarryforwardgrantsutil.computeCarryForwardGrants)({
            ...
            const result = (0, _computecarryforwardgrantsutil.computeCarryForwardGrants)({
                ...
                liveGrants: [
                    grant({
                        ...
                        type: _billingcreditgranttypeenum.BillingCreditGrantType.COMPENSATION,
...
//# sourceMappingURL=compute-carry-forward-grants.util.spec.js.map