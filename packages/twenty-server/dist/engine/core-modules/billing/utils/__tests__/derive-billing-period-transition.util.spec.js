...
const _derivebillingperiodtransitionutil = require("../derive-billing-period-transition.util");
...
describe('deriveBillingPeriodTransition', ()=>{
    it('treats the invoiced period start as the boundary between the two periods', ()=>{
        const result = (0, _derivebillingperiodtransitionutil.deriveBillingPeriodTransition)({
            ...
            subscriptionInterval: _billingsubscriptionintervalenum.SubscriptionInterval.Month,
            trialStart: null,
    ...
    it('falls back one calendar year for a yearly subscription', ()=>{
        const result = (0, _derivebillingperiodtransitionutil.deriveBillingPeriodTransition)({
            ...
            subscriptionInterval: _billingsubscriptionintervalenum.SubscriptionInterval.Year,
            trialStart: null,
            isFirstPeriodAfterTrial: false,
            subscriptionPreviousPeriodStart: null,
            ledgerPeriodStart: null
        });
        expect(result.closingPeriodStart).toEqual(new Date('2025-01-01T00:00:00.000Z'));
    });
    it('keeps the closing period aligned across a leap February', ()=>{
        ...
        expect(result.closingPeriodStart).toEqual(new Date('2024-02-01T00:00:00.000Z'));
    });
    ...
    it('prefers the period start the subscription recorded over the ledger', ()=>{
        ...
        expect(result.closingPeriodStart).toEqual(new Date('2026-01-31T00:00:00.000Z'));
    });
...
//# sourceMappingURL=derive-billing-period-transition.util.spec.js.map