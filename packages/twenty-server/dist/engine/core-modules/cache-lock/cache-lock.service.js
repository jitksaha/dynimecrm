...
const _cachelockexception = require("./exceptions/cache-lock.exception");
...
let CacheLockService = class CacheLockService {
    ...
    async withLock(fn, key, options) {
        ...
        throw new _cachelockexception.CacheLockException(`Failed to acquire lock for key: ${key}`, _cachelockexception.CacheLockExceptionCode.LOCK_ACQUISITION_TIMEOUT);
    }
