...
const _parsepeopledatalabsresponseitemutil = require("../parse-people-data-labs-response-item.util");
describe('parsePeopleDataLabsResponseItem', ()=>{
    it('maps a 200 item to a matched outcome with data and likelihood', ()=>{
        expect((0, _parsepeopledatalabsresponseitemutil.parsePeopleDataLabsResponseItem)({
            item: {
                status: 200,
                likelihood: 8,
                data: {
...
//# sourceMappingURL=parse-people-data-labs-response-item.util.spec.js.map