...
const _toworkspacepersonenrichmentutil = require("../to-workspace-person-enrichment.util");
describe('toWorkspacePersonEnrichment', ()=>{
    ...
    it('should map the People Data Labs fields onto the workspace shape', ()=>{
        const result = (0, _toworkspacepersonenrichmentutil.toWorkspacePersonEnrichment)({
            email: 'ada@acme.com',
            enrichedAt,
            data: {
    ...
    it('should fall back to the job company industry when the person has none', ()=>{
        const result = (0, _toworkspacepersonenrichmentutil.toWorkspacePersonEnrichment)({
            ...
            enrichedAt,
            data: {
                job_company_industry: 'manufacturing'
            }
        });
...
//# sourceMappingURL=to-workspace-person-enrichment.util.spec.js.map