...
const _customdomainactivated = require("../../../event-logs/emit/events/workspace-event/custom-domain/custom-domain-activated");
const _customdomaindeactivated = require("../../../event-logs/emit/events/workspace-event/custom-domain/custom-domain-deactivated");
...
let CustomDomainManagerService = class CustomDomainManagerService {
    ...
    async checkCustomDomainValidRecords(workspace, domainValidRecord) {
        ...
        if (workspace.isCustomDomainEnabled !== isCustomDomainWorking) {
            ...
            void eventLogContext.insertWorkspaceEvent(workspace.isCustomDomainEnabled ? _customdomainactivated.CUSTOM_DOMAIN_ACTIVATED_EVENT : _customdomaindeactivated.CUSTOM_DOMAIN_DEACTIVATED_EVENT, {});
        }
        return {
    ...
    publicDomainRepository, billingService, dnsManagerService, eventLogEmitterService){
