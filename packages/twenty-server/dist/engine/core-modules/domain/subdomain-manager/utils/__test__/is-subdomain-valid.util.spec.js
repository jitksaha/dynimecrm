...
describe('isSubdomainValid', ()=>{
    describe('valid subdomains', ()=>{
        ...
        it('should accept minimum length subdomains (1 character)', ()=>{
            expect((0, _issubdomainvalidutil.isSubdomainValid)('a')).toBe(true);
            expect((0, _issubdomainvalidutil.isSubdomainValid)('1')).toBe(true);
            expect((0, _issubdomainvalidutil.isSubdomainValid)('ab')).toBe(true);
