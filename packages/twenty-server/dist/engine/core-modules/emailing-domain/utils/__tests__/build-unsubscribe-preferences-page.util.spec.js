...
const _buildunsubscribepreferencespageutil = require("../build-unsubscribe-preferences-page.util");
const buildPage = (topics)=>(0, _buildunsubscribepreferencespageutil.buildUnsubscribePreferencesPage)({
        token: 'token-1',
        topics,
...
describe('buildUnsubscribePreferencesPage', ()=>{
    ...
    it('escapes the token in every form', ()=>{
        const page = (0, _buildunsubscribepreferencespageutil.buildUnsubscribePreferencesPage)({
...
//# sourceMappingURL=build-unsubscribe-preferences-page.util.spec.js.map