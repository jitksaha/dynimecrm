...
describe('objectRecordChangedValues', ()=>{
    ...
    describe('with a MANY_TO_ONE relation field', ()=>{
        ...
        const objectMetadataWithRelation = {
            ...mockObjectMetadata,
            fieldIds: [
                relationFieldId
            ]
        ...
        it('records join column changes under the relation field name', ()=>{
            ...
            const result = (0, _objectrecordchangedvalues.objectRecordChangedValues)(oldRecord, newRecord, objectMetadataWithRelation, flatFieldMetadataMapsWithRelation);
            expect(result).toEqual({
                company: {
                    before: {
                        id: 'old-company-id'
        ...
        it('computes updatedFields with both relation field name and join column name', ()=>{
            ...
            const updatedFields = (0, _objectrecordchangedvalues.computeUpdatedFieldsFromDiff)(diff, objectMetadataWithRelation, flatFieldMetadataMapsWithRelation);
        ...
        it('uses the canonical computed join column name even when settings diverge', ()=>{
            const flatFieldMetadataMapsWithDivergentJoinColumn = {
                ...flatFieldMetadataMapsWithRelation,
                byUniversalIdentifier: {
                    [relationUniversalId]: {
                        ...flatFieldMetadataMapsWithRelation.byUniversalIdentifier[relationUniversalId],
                        settings: {
                            relationType: _types.RelationType.MANY_TO_ONE,
            ...
            const updatedFields = (0, _objectrecordchangedvalues.computeUpdatedFieldsFromDiff)(diff, objectMetadataWithRelation, flatFieldMetadataMapsWithDivergentJoinColumn);
            expect(updatedFields).toEqual([
                'company',
                'companyId'
            ]);
