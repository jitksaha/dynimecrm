...
const _eventlogemitterresolver = require("./event-log-emitter.resolver");
...
describe('EventLogEmitterResolver', ()=>{
    ...
    beforeEach(async ()=>{
        ...
        resolver = module.get(_eventlogemitterresolver.EventLogEmitterResolver);
    });
    ...
    it('should throw an EventLogEmitterException for invalid input', async ()=>{
        ...
        await expect(resolver.trackAnalytics(invalidInput, undefined, undefined)).rejects.toThrowError(new _eventlogemitterexception.EventLogEmitterException('Invalid analytics input', _eventlogemitterexception.EventLogEmitterExceptionCode.INVALID_TYPE));
    });
    it('should throw an EventLogEmitterException when workspace is missing for createObjectEvent', async ()=>{
        ...
        await expect(resolver.createObjectEvent(input, undefined, undefined)).rejects.toThrowError(new _eventlogemitterexception.EventLogEmitterException('Missing workspace', _eventlogemitterexception.EventLogEmitterExceptionCode.INVALID_INPUT));
    });
});

//# sourceMappingURL=event-log-emitter.resolver.spec.js.map