...
const _validatefolderpathutil = require("../validate-folder-path.util");
describe('validateFolderPath', ()=>{
    it.each([
        ...
        {
            title: 'nested folder path',
            folderPath: '0000-0999/tmp200/toto'
        },
        {
            title: 'dot-prefixed hidden folder',
            folderPath: '.hidden'
        }
    ])('should return isValid: true for $title', ({ folderPath })=>{
        expect((0, _validatefolderpathutil.validateFolderPath)({
            folderPath
        })).toEqual({
            isValid: true
        });
    ...
    it('should fail on path traversal', ()=>{
        const result = (0, _validatefolderpathutil.validateFolderPath)({
    ...
    it.each([
        ...
        {
            title: 'double slashes',
            folderPath: 'my-folder//sub'
        }
    ...
    it.each([
        ...
        {
            title: '.woff2 extension',
            folderPath: 'fonts/roboto.woff2'
        },
        {
            title: '.pdf extension',
            folderPath: 'docs/report.pdf'
        },
        {
            title: '.csv extension',
            folderPath: 'data/export.csv'
        },
        {
        ...
        {
            title: 'dotted version string (v1.0.0)',
            folderPath: 'v1.0.0'
        },
        {
            title: 'numeric extension (.123)',
...
//# sourceMappingURL=validate-folder-path.util.spec.js.map