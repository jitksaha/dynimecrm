...
describe('validateSafeRelativePath', ()=>{
    it.each([
        {
            title: 'nested relative path',
            resourcePath: 'src/components/test.mjs'
        },
        {
            title: 'simple filename',
            resourcePath: 'file.mjs'
        },
        {
            title: 'deeply nested path',
            resourcePath: 'a/b/c/d.txt'
        }
    ])('should return isValid: true for $title', ({ resourcePath })=>{
        expect((0, _validatesaferelativepathutil.validateSafeRelativePath)({
            resourcePath
        })).toEqual({
            isValid: true
        });
    ...
    ])('should return isValid: false for $title', ({ resourcePath, expectedError })=>{
        const result = (0, _validatesaferelativepathutil.validateSafeRelativePath)({
            resourcePath
        });
...
//# sourceMappingURL=validate-safe-relative-path.util.spec.js.map