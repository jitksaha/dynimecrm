...
describe('removeFileFolderFromFileEntityPath', ()=>{
    it('should remove file folder prefix from path', ()=>{
        expect((0, _removefilefolderfromfileentitypathutils.removeFileFolderFromFileEntityPath)(`${_types.FileFolder.FilesField}/file.txt`)).toBe('file.txt');
    });
    it('should handle nested paths correctly', ()=>{
        expect((0, _removefilefolderfromfileentitypathutils.removeFileFolderFromFileEntityPath)(`${_types.FileFolder.FilesField}/subfolder/file.txt`)).toBe('subfolder/file.txt');
    });
    it('should work with different valid file folders', ()=>{
        expect((0, _removefilefolderfromfileentitypathutils.removeFileFolderFromFileEntityPath)(`${_types.FileFolder.CorePicture}/avatar.png`)).toBe('avatar.png');
        expect((0, _removefilefolderfromfileentitypathutils.removeFileFolderFromFileEntityPath)(`${_types.FileFolder.Workflow}/logo.svg`)).toBe('logo.svg');
