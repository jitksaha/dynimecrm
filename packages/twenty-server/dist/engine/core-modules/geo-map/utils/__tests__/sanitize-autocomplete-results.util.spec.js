...
const _sanitizeautocompleteresultsutil = require("../sanitize-autocomplete-results.util");
...
describe('sanitizeAutocompleteResults', ()=>{
    it('should return empty array for empty input', ()=>{
        expect((0, _sanitizeautocompleteresultsutil.sanitizeAutocompleteResults)([])).toEqual([]);
    });
    it('should map predictions to text and placeId', ()=>{
        const result = (0, _sanitizeautocompleteresultsutil.sanitizeAutocompleteResults)(GOOGLE_PREDICTIONS);
    ...
    it('should map a single prediction', ()=>{
        const result = (0, _sanitizeautocompleteresultsutil.sanitizeAutocompleteResults)([
...
//# sourceMappingURL=sanitize-autocomplete-results.util.spec.js.map