...
const _sanitizeplacedetailsresultsutil = require("../sanitize-place-details-results.util");
// Real Google Places API response for "48 Pirrama Road, Pyrmont NSW 2009, Australia"
const GOOGLE_OFFICE_SYDNEY = [
    {
        long_name: '48',
        short_name: '48',
        types: [
...
describe('sanitizePlaceDetailsResults', ()=>{
    it('should return empty object for empty array', ()=>{
        expect((0, _sanitizeplacedetailsresultsutil.sanitizePlaceDetailsResults)({
            addressComponents: []
        })).toEqual({});
    });
    it('should parse a full US address (Google Sydney office)', ()=>{
        const result = (0, _sanitizeplacedetailsresultsutil.sanitizePlaceDetailsResults)({
...
//# sourceMappingURL=sanitize-place-details-results.util.spec.js.map