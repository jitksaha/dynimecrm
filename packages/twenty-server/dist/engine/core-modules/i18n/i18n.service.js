...
let I18nService = class I18nService {
    async loadTranslations() {
        ...
        _core.i18n.setMessagesCompiler(_compileMessage.compileMessage);
        _core.i18n.load(_translations.SOURCE_LOCALE, _en.messages);
        _core.i18n.activate(_translations.SOURCE_LOCALE);
        ...
        Object.entries(messagesByLocale).forEach(([locale, messages])=>{
            ...
            localeI18n.setMessagesCompiler(_compileMessage.compileMessage);
