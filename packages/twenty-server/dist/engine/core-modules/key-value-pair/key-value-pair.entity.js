...
_ts_decorate([
    ...
    _ts_metadata("design:type", Object)
], KeyValuePairEntity.prototype, "application", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true,
        type: 'uuid'
    ...
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: '2.24.0_RepairKeyValuePairApplicationIdFastInstanceCommand_1784897347051'
    }),
    _ts_metadata("design:type", Object)
], KeyValuePairEntity.prototype, "applicationId", void 0);
_ts_decorate([
...
KeyValuePairEntity = _ts_decorate([
    ...
    (0, _typeorm.Index)('IDX_KEY_VALUE_PAIR_KEY_NULL_USER_ID_NULL_WORKSPACE_ID_UNIQUE', [
        ...
        unique: true,
        where: '"userId" is NULL AND "workspaceId" is NULL AND "applicationId" is NULL'
    }),
    (0, _typeorm.Index)('IDX_KEY_VALUE_PAIR_KEY_APPLICATION_ID_WORKSPACE_UNIQUE', [
        'key',
        'applicationId'
    ], {
        unique: true,
    ...
    (0, _typeorm.Index)('IDX_KEY_VALUE_PAIR_KEY_APPLICATION_ID_GLOBAL_UNIQUE', [
        'key',
        'applicationId'
    ], {
        unique: true,
    ...
    (0, _typeorm.Index)('IDX_KEY_VALUE_PAIR_APPLICATION_ID', [
        'applicationId'
    ])
], KeyValuePairEntity);
