...
let DisabledDriver = class DisabledDriver {
    ...
    async installPrebuiltBundle() {
        throw new _logicfunctionexception.LogicFunctionException('Logic function prebuilt install is disabled. Set LOGIC_FUNCTION_TYPE to LOCAL or LAMBDA to enable.', _logicfunctionexception.LogicFunctionExceptionCode.LOGIC_FUNCTION_DISABLED);
    }
