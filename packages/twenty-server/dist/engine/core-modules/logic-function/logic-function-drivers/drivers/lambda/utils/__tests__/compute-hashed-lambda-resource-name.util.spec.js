...
const _computehashedlambdaresourcenameutil = require("../compute-hashed-lambda-resource-name.util");
describe('computeHashedLambdaResourceName', ()=>{
    it('returns prefix concatenated with a 12-character sha256 hex checksum of the contents', ()=>{
        const name = (0, _computehashedlambdaresourcenameutil.computeHashedLambdaResourceName)({
    ...
    it('keeps the checksum stable and only prepends the namespace', ()=>{
        const withoutNamespace = (0, _computehashedlambdaresourcenameutil.computeHashedLambdaResourceName)({
            resourceNamePrefix: 'twenty-builder',
            contents: [
                'handler-code'
            ]
        });
        const withNamespace = (0, _computehashedlambdaresourcenameutil.computeHashedLambdaResourceName)({
            resourceNamePrefix: 'twenty-builder',
            namespace: 'abc123def0',
            contents: [
                'handler-code'
...
//# sourceMappingURL=compute-hashed-lambda-resource-name.util.spec.js.map