...
const _getlambdaresourcenamespaceutil = require("./drivers/lambda/utils/get-lambda-resource-namespace.util");
            ...
            case _logicfunctiondriverinterface.LogicFunctionDriverType.LAMBDA:
                {
                    ...
                    const resourceNamespace = (0, _getlambdaresourcenamespaceutil.getLambdaResourceNamespace)({
