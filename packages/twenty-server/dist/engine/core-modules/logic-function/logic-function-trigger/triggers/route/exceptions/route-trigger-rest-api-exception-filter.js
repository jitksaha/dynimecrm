...
let RouteTriggerRestApiExceptionFilter = class RouteTriggerRestApiExceptionFilter {
        ...
        switch(exception.code){
            ...
            case _routetriggerexception.RouteTriggerExceptionCode.WORKSPACE_SUSPENDED:
            ...
            case _routetriggerexception.RouteTriggerExceptionCode.LEGACY_ROUTE_DEPRECATED:
                return this.httpExceptionHandlerService.handleError(exception, response, 410);
            case _routetriggerexception.RouteTriggerExceptionCode.LOGIC_FUNCTION_DEPENDENCIES_SIZE_EXCEEDED:
                return this.httpExceptionHandlerService.handleError(exception, response, 422, undefined, undefined, {
                    shouldBeCapturedBySentry: false
                });
            case _routetriggerexception.RouteTriggerExceptionCode.ROUTE_TRIGGER_USER_UNCAUGHT_ERROR:
                return this.httpExceptionHandlerService.handleError(exception, response, 500, undefined, undefined, {
                    shouldBeCapturedBySentry: false
                });
            case _routetriggerexception.RouteTriggerExceptionCode.ROUTE_TRIGGER_PLATFORM_ERROR:
