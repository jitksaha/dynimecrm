...
const _logicfunctiondriverfactorytoken = require("./logic-function-drivers/constants/logic-function-driver-factory.token");
    ...
    static forRoot() {
        return {
            ...
            providers: [
                ...
                {
                    provide: _logicfunctiondriverfactorytoken.LOGIC_FUNCTION_DRIVER_FACTORY_TOKEN,
                    useExisting: _logicfunctiondriverfactory.LogicFunctionDriverFactory
                }
            ],
            exports: [
                _logicfunctiondriverfactory.LogicFunctionDriverFactory,
                _logicfunctiondriverfactorytoken.LOGIC_FUNCTION_DRIVER_FACTORY_TOKEN,
                _logicfunctionresourcemodule.LogicFunctionResourceModule,
                _logicfunctiontriggermodule.LogicFunctionTriggerModule,
                _logicfunctionexecutormodule.LogicFunctionExecutorModule
            ]
