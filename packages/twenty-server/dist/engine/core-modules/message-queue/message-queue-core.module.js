...
const _applicationjobenqueuethrottlerservice = require("./services/application-job-enqueue-throttler.service");
    ...
    static register(options) {
        ...
        return {
            ...
            providers: [
                ...
                _applicationjobenqueuethrottlerservice.ApplicationJobEnqueueThrottlerService,
                driverProvider,
                ...queueProviders
            ],
            exports: [
