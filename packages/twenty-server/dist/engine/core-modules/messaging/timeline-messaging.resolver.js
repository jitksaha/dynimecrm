...
let GetTimelineThreadsFromObjectRecordArgs = class GetTimelineThreadsFromObjectRecordArgs {
};
_ts_decorate([
    (0, _graphql.Field)(()=>String),
    _ts_metadata("design:type", String)
], GetTimelineThreadsFromObjectRecordArgs.prototype, "objectNameSingular", void 0);
_ts_decorate([
    (0, _graphql.Field)(()=>_scalars.UUIDScalarType),
    _ts_metadata("design:type", String)
], GetTimelineThreadsFromObjectRecordArgs.prototype, "recordId", void 0);
_ts_decorate([
    (0, _graphql.Field)(()=>_graphql.Int),
    _ts_metadata("design:type", Number)
], GetTimelineThreadsFromObjectRecordArgs.prototype, "page", void 0);
_ts_decorate([
    (0, _graphql.Field)(()=>_graphql.Int),
    (0, _classvalidator.Max)(_messagingconstants.TIMELINE_THREADS_MAX_PAGE_SIZE),
    _ts_metadata("design:type", Number)
], GetTimelineThreadsFromObjectRecordArgs.prototype, "pageSize", void 0);
GetTimelineThreadsFromObjectRecordArgs = _ts_decorate([
    (0, _graphql.ArgsType)()
...
let TimelineMessagingResolver = class TimelineMessagingResolver {
    async getTimelineThreadsFromObjectRecord(user, workspace, { objectNameSingular, recordId, page, pageSize }) {
        const workspaceMember = await this.userService.loadWorkspaceMember(user, workspace);
        if (!workspaceMember) {
            return;
        }
        return this.getMessagesFromPersonIdsService.getMessagesFromObjectRecord(workspaceMember.id, objectNameSingular, recordId, workspace.id, page, pageSize);
    }
    async getTimelineThreadsFromPersonId(user, workspace, { personId, page, pageSize }) {
        ...
        return this.getMessagesFromPersonIdsService.getMessagesFromObjectRecord(workspaceMember.id, _types.CoreObjectNameSingular.Person, personId, workspace.id, page, pageSize);
    }
    async getTimelineThreadsFromCompanyId(user, workspace, { companyId, page, pageSize }) {
        ...
        return this.getMessagesFromPersonIdsService.getMessagesFromObjectRecord(workspaceMember.id, _types.CoreObjectNameSingular.Company, companyId, workspace.id, page, pageSize);
    }
    async getTimelineThreadsFromOpportunityId(user, workspace, { opportunityId, page, pageSize }) {
        ...
        return this.getMessagesFromPersonIdsService.getMessagesFromObjectRecord(workspaceMember.id, _types.CoreObjectNameSingular.Opportunity, opportunityId, workspace.id, page, pageSize);
    }
...
_ts_decorate([
    ...
    _ts_metadata("design:paramtypes", [
        ...
        typeof GetTimelineThreadsFromObjectRecordArgs === "undefined" ? Object : GetTimelineThreadsFromObjectRecordArgs
    ]),
    _ts_metadata("design:returntype", Promise)
], TimelineMessagingResolver.prototype, "getTimelineThreadsFromObjectRecord", null);
_ts_decorate([
    (0, _graphql.Query)(()=>_timelinethreadswithtotaldto.TimelineThreadsWithTotalDTO, {
