...
let MetricsService = class MetricsService {
    ...
    createMultiObservableGauge({ metricName, options, callback, cacheValue = false }) {
        return this.createObservableGaugeInternal({
            metricName,
            options,
            callback,
    ...
    createObservableGaugeInternal({ metricName, options, callback, cacheValue, observeResult }) {
    ...
    recordHistogram({ key, value, unit, attributes, bucketBoundaries }) {
        this.getMeter().createHistogram(key, {
            unit,
            ...(0, _utils.isDefined)(bucketBoundaries) && {
                advice: {
