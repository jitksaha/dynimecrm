...
const computeDuplicatesResultPath = (item)=>{
    return {
        post: {
            tags: [
                item.namePlural
...
const computeRestoreOneResultPath = (item)=>{
    return {
        patch: {
            tags: [
                item.namePlural
...
const computeRestoreManyResultPath = (item)=>{
    return {
        patch: {
            tags: [
                item.namePlural
...
const computeMergeManyResultPath = (item)=>{
    return {
        patch: {
            tags: [
                item.namePlural
...
const computeGroupByResultPath = (item)=>{
    return {
        get: {
            tags: [
                item.namePlural
