...
const _deletemanyrecordsservice = require("./services/delete-many-records.service");
...
const _upsertmanyrecordsservice = require("./services/upsert-many-records.service");
...
RecordCrudModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            ...
            _deletemanyrecordsservice.DeleteManyRecordsService,
            ...
            _upsertmanyrecordsservice.UpsertManyRecordsService
        ],
        exports: [
            _createrecordservice.CreateRecordService,
            _createmanyrecordsservice.CreateManyRecordsService,
