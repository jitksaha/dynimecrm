...
const generateRecordFilterSchema = ({ objectMetadata, restrictedFields, additionalExcludedFieldNames = [] })=>{
    const filterShape = {};
    objectMetadata.fields.forEach((field)=>{
        if ((0, _utils.shouldExcludeFieldFromAgentToolSchema)({
        ...
        const isManyToOneRelationField = ((0, _isfieldmetadataoftypeutil.isFieldMetadataEntityOfType)(field, _types.FieldMetadataType.RELATION) || (0, _isfieldmetadataoftypeutil.isFieldMetadataEntityOfType)(field, _types.FieldMetadataType.MORPH_RELATION)) && field.settings?.relationType === _types.RelationType.MANY_TO_ONE;
