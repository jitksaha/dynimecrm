...
let RecordInputTransformerService = class RecordInputTransformerService {
    async process({ recordInput, flatObjectMetadata, flatFieldMetadataMaps }) {
        ...
        for (const [key, value] of Object.entries(recordInput)){
            ...
            const transformedValue = this.parseSubFields(fieldMetadata.type, await this.transformFieldValue(fieldMetadata, this.stringifySubFields(fieldMetadata.type, value)));
            transformedEntries = {
                ...transformedEntries,
    ...
    async transformFieldValue(fieldMetadata, // oxlint-disable-next-line typescript/no-explicit-any
    value) {
        ...
        switch(fieldMetadata.type){
            ...
            case _types.FieldMetadataType.LINKS:
                return (0, _transformlinksvalueutil.transformLinksValue)({
                    input: value,
                    settings: (0, _isfieldmetadatasettingsoftypeutil.isFieldMetadataSettingsOfType)(fieldMetadata.settings, _types.FieldMetadataType.LINKS) ? fieldMetadata.settings : null
                });
    ...
    parseSubFields(fieldMetadataType, value) {
        ...
        return Object.entries(value).reduce(// oxlint-disable-next-line typescript/no-explicit-any
