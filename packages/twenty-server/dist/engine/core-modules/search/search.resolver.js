...
let SearchResolver = class SearchResolver {
    async search(workspace, { searchInput, limit, filter, includedObjectNameSingulars, excludedObjectNameSingulars, after }, context) {
...
SearchResolver = _ts_decorate([
    ...
    (0, _common.UseFilters)(_searchapiexceptionfilter.SearchApiExceptionFilter, _permissionsgraphqlapiexceptionfilter.PermissionsGraphqlApiExceptionFilter, _preventnesttoautologgraphqlerrorsfilter.PreventNestToAutoLogGraphqlErrorsFilter),
