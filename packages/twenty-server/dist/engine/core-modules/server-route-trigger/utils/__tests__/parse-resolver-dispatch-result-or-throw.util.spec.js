...
const _parseresolverdispatchresultorthrowutil = require("../parse-resolver-dispatch-result-or-throw.util");
const WORKSPACE_ID = '20202020-1c25-4d02-bf25-6aeccf7ea419';
const TARGET_UNIVERSAL_IDENTIFIER = 'c4e2a9b1-7d4e-4c9a-9f2b-2e1d6a4c8e10';
const expectInvalidResult = (data)=>expect(()=>(0, _parseresolverdispatchresultorthrowutil.parseResolverDispatchResultOrThrow)(data)).toThrow(expect.objectContaining({
        code: _serverroutetriggerexception.ServerRouteTriggerExceptionCode.RESOLVER_INVALID_RESULT
    }));
describe('parseResolverDispatchResultOrThrow', ()=>{
    it('should return the dispatch target when the resolver returns one', ()=>{
        expect((0, _parseresolverdispatchresultorthrowutil.parseResolverDispatchResultOrThrow)({
...
//# sourceMappingURL=parse-resolver-dispatch-result-or-throw.util.spec.js.map