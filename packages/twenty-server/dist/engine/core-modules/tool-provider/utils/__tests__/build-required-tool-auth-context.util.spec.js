...
describe('buildRequiredToolAuthContext', ()=>{
    ...
    it('should build a user auth context from the tool identity', async ()=>{
        ...
        const authContext = await (0, _buildrequiredtoolauthcontextutil.buildRequiredToolAuthContext)({
    ...
    it('should throw without a resolvable identity', async ()=>{
        await expect((0, _buildrequiredtoolauthcontextutil.buildRequiredToolAuthContext)({
            context: buildContext(),
            ...buildDependencies()
...
//# sourceMappingURL=build-required-tool-auth-context.util.spec.js.map