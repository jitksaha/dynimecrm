...
let NavigateAppTool = class NavigateAppTool {
    async execute(parameters, context) {
        ...
        const input = parseResult.data.navigation;
        switch(input.type){
            case 'navigateToView':
    ...
    async navigateToRecord(objectNameSingular, recordName, workspaceId) {
        ...
        const records = await this.workspaceOrmManager.executeInWorkspaceContext(async ()=>{
            const repository = this.workspaceOrmManager.getRepository(objectNameSingular, {
    ...
    constructor(navigationMenuItemService, viewService, workspaceManyOrAllFlatEntityMapsCacheService, workspaceOrmManager){
