...
_export(exports, {
    get NavigateAppActionZodSchema () {
        return NavigateAppActionZodSchema;
    },
    get NavigateAppInputZodSchema () {
        return NavigateAppInputZodSchema;
    }
});
const _zod = require("zod");
const NavigateAppActionZodSchema = _zod.z.discriminatedUnion('type', [
    _zod.z.object({
...
const NavigateAppInputZodSchema = _zod.z.object({
    navigation: NavigateAppActionZodSchema.describe('The navigation action to perform.')
});
