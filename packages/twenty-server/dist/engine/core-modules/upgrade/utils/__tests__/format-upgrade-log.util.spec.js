...
`);
    ...
    it('matches the summary call site emitted by UpgradeCommand at the end of a run', ()=>{
        expect((0, _formatupgradelogutil.formatUpgradeLog)({
            humanMessage: 'Upgrade summary: 42 workspace(s) succeeded, 1 workspace(s) failed',
            event: 'summary',
            logFields: {
                totalSuccesses: 42,
                totalFailures: 1,
...
`);
    ...
    it('preserves a multi-line humanMessage as-is and keeps the structured tail on its own single line', ()=>{
        const errorMessage = 'Workspace migration runner failed:\n  - Option id is required\n  - Option id is invalid';
        expect((0, _formatupgradelogutil.formatUpgradeLog)({
...
`);
    ...
    it('quotes values containing whitespace, quotes or equals signs', ()=>{
        expect((0, _formatupgradelogutil.formatUpgradeLog)({
            humanMessage: 'Workspace abc failed on migrate-foo: Connection timed out',
...
//# sourceMappingURL=format-upgrade-log.util.spec.js.map