...
const _buildspeedbucketsutil = require("../build-speed-buckets.util");
const workspace = {
    id: 'workspace-1'
};
// The registry defaults, standing in for API_RATE_LIMITING_* and
// APPLICATION_API_RATE_LIMITING_*.
const DEFAULT_USAGE_LIMIT_FALLBACKS = [
    {
        spenderType: 'apiKey',
...
const buildBuckets = ({ authContext, rules = [], defaultUsageLimitFallbacks = DEFAULT_USAGE_LIMIT_FALLBACKS })=>(0, _buildspeedbucketsutil.buildSpeedBuckets)({
...
//# sourceMappingURL=build-speed-buckets.util.spec.js.map