...
(0, _graphql.registerEnumType)(_types.OpenRecordIn, {
    name: 'OpenRecordIn'
});
...
_ts_decorate([
    ...
    _ts_metadata("design:type", String)
], WorkspaceMemberDTO.prototype, "uiScale", void 0);
_ts_decorate([
    (0, _graphql.Field)(()=>_types.OpenRecordIn, {
        nullable: false
    }),
    _ts_metadata("design:type", typeof _types.OpenRecordIn === "undefined" ? Object : _types.OpenRecordIn)
], WorkspaceMemberDTO.prototype, "openRecordIn", void 0);
_ts_decorate([
    (0, _graphql.Field)({
        nullable: true
    }),
