...
let WorkflowTriggerController = class WorkflowTriggerController {
    ...
    async runWorkflow({ workflowId, payload, workspaceId }) {
        ...
        try {
            const { workflow } = await this.workspaceOrmManager.executeInWorkspaceContext(async ()=>{
    ...
    constructor(workspaceOrmManager, workflowTriggerWorkspaceService, workspaceRepository){
...
WorkflowTriggerController = _ts_decorate([
    (0, _common.Controller)(_types.ApiPath.Webhooks),
