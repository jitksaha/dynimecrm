...
Object.defineProperty(exports, "CoreWorkflowResolver", {
    enumerable: true,
    get: function() {
        return CoreWorkflowResolver;
    }
});
...
const _coreworkflowconnectiondto = require("../dtos/core-workflow-connection.dto");
const _coreworkflowsinput = require("../dtos/core-workflows.input");
const _coreworkflowlistservice = require("../services/core-workflow-list.service");
...
let CoreWorkflowResolver = class CoreWorkflowResolver {
    async coreWorkflows({ id: workspaceId }, coreWorkflowsArgs) {
        return this.coreWorkflowListService.findManyByWorkspaceId(workspaceId, coreWorkflowsArgs);
    }
    constructor(coreWorkflowListService){
        this.coreWorkflowListService = coreWorkflowListService;
    }
};
_ts_decorate([
    (0, _graphql.Query)(()=>_coreworkflowconnectiondto.CoreWorkflowConnectionDTO),
    _ts_param(0, (0, _authworkspacedecorator.AuthWorkspace)()),
    _ts_param(1, (0, _graphql.Args)()),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _workspaceentity.WorkspaceEntity === "undefined" ? Object : _workspaceentity.WorkspaceEntity,
        typeof _coreworkflowsinput.CoreWorkflowsArgs === "undefined" ? Object : _coreworkflowsinput.CoreWorkflowsArgs
    ]),
    _ts_metadata("design:returntype", Promise)
], CoreWorkflowResolver.prototype, "coreWorkflows", null);
CoreWorkflowResolver = _ts_decorate([
    ...
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _coreworkflowlistservice.CoreWorkflowListService === "undefined" ? Object : _coreworkflowlistservice.CoreWorkflowListService
    ])
], CoreWorkflowResolver);

//# sourceMappingURL=core-workflow.resolver.js.map