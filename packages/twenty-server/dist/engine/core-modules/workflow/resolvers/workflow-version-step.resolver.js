...
const _updateworkflowversiontriggerinput = require("../dtos/update-workflow-version-trigger.input");
...
const _workflowversiontriggerdto = require("../dtos/workflow-version-trigger.dto");
...
let WorkflowVersionStepResolver = class WorkflowVersionStepResolver {
    ...
    async updateWorkflowVersionTrigger({ id: workspaceId }, { trigger, workflowVersionId }) {
...
_ts_decorate([
    (0, _graphql.Mutation)(()=>_workflowversiontriggerdto.WorkflowVersionTriggerDTO),
    _ts_param(0, (0, _authworkspacedecorator.AuthWorkspace)()),
    _ts_param(1, (0, _graphql.Args)('input')),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof _workspaceentity.WorkspaceEntity === "undefined" ? Object : _workspaceentity.WorkspaceEntity,
        typeof _updateworkflowversiontriggerinput.UpdateWorkflowVersionTriggerInput === "undefined" ? Object : _updateworkflowversiontriggerinput.UpdateWorkflowVersionTriggerInput
    ]),
    _ts_metadata("design:returntype", Promise)
], WorkflowVersionStepResolver.prototype, "updateWorkflowVersionTrigger", null);
_ts_decorate([
    (0, _graphql.Mutation)(()=>_workflowversionstepchangesdto.WorkflowVersionStepChangesDTO),
    _ts_param(0, (0, _authworkspacedecorator.AuthWorkspace)()),
    _ts_param(1, (0, _graphql.Args)('input')),
