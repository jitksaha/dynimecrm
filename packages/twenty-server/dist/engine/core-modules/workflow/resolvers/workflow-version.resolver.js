...
const _workflowversioncontentdto = require("../dtos/workflow-version-content.dto");
...
let WorkflowVersionResolver = class WorkflowVersionResolver {
    async workflowVersionContent({ id: workspaceId }, workflowVersionId) {
    ...
    constructor(workflowVersionWorkspaceService, workflowCommonWorkspaceService){
...
_ts_decorate([
    (0, _graphql.Query)(()=>_workflowversioncontentdto.WorkflowVersionContentDTO),
...
], WorkflowVersionResolver.prototype, "workflowVersionContent", null);
_ts_decorate([
