...
const _coreworkflowresolver = require("./resolvers/core-workflow.resolver");
...
const _workflowversioncoremodule = require("./workflow-version-core.module");
...
WorkflowApiModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            ...
            _coreworkflowresolver.CoreWorkflowResolver,
            _coreworkflowlistservice.CoreWorkflowListService
        ]
    })
], WorkflowApiModule);
