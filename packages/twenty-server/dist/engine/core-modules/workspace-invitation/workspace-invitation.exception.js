...
var WorkspaceInvitationExceptionCode = /*#__PURE__*/ function(WorkspaceInvitationExceptionCode) {
    ...
    WorkspaceInvitationExceptionCode["TOO_MANY_ONBOARDING_INVITATIONS"] = "TOO_MANY_ONBOARDING_INVITATIONS";
    return WorkspaceInvitationExceptionCode;
}({});
const getWorkspaceInvitationExceptionUserFriendlyMessage = (code)=>{
    switch(code){
        ...
        case "TOO_MANY_ONBOARDING_INVITATIONS":
            return /*i18n*/ {
                id: "WCKl4k",
                message: "You have reached the maximum number of invitations for this step."
            };
        default:
