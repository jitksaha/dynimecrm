...
describe('workspaceGraphqlApiExceptionHandler', ()=>{
    ...
    it('should throw ConflictError when application uninstall blocks reactivation', ()=>{
        const error = new _workspaceexception.WorkspaceException('Application uninstall in progress', _workspaceexception.WorkspaceExceptionCode.APPLICATION_UNINSTALL_IN_PROGRESS);
        expect(()=>(0, _workspacegraphqlapiexceptionhandlerutil.workspaceGraphqlApiExceptionHandler)(error)).toThrow(_graphqlerrorsutil.ConflictError);
    });
