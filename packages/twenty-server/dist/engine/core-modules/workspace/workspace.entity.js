...
const _addworkspacediscoverabilitytoworkspaceupgradecommandnameconstant = require("../../../database/commands/upgrade-version-command/2-19/add-workspace-discoverability-to-workspace-upgrade-command-name.constant");
...
const _workspacediscoverabilitytype = require("./types/workspace-discoverability.type");
...
(0, _graphql.registerEnumType)(_workspacediscoverabilitytype.WorkspaceDiscoverability, {
...
_ts_decorate([
    (0, _graphql.Field)(()=>_workspacediscoverabilitytype.WorkspaceDiscoverability),
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: _addworkspacediscoverabilitytoworkspaceupgradecommandnameconstant.ADD_WORKSPACE_DISCOVERABILITY_TO_WORKSPACE_UPGRADE_COMMAND_NAME
    }),
    (0, _typeorm.Column)({
        type: 'enum',
        enumName: 'workspace_discoverability_enum',
        enum: _workspacediscoverabilitytype.WorkspaceDiscoverability,
        default: _workspacediscoverabilitytype.WorkspaceDiscoverability.PUBLIC
    }),
    _ts_metadata("design:type", typeof _workspacediscoverabilitytype.WorkspaceDiscoverability === "undefined" ? Object : _workspacediscoverabilitytype.WorkspaceDiscoverability)
], WorkspaceEntity.prototype, "workspaceDiscoverability", void 0);
_ts_decorate([
    (0, _graphql.Field)(),
    (0, _typeorm.Column)({
        type: 'integer',
...
_ts_decorate([
    (0, _graphql.Field)({
        deprecationReason: 'No longer used for metadata cache invalidation, will be removed'
    }),
    (0, _typeorm.Column)({
        default: 1
    }),
...
WorkspaceEntity = _ts_decorate([
    ...
    (0, _typeorm.Check)('workspace_requires_database_schema', `"activationStatus" IN ('PENDING_CREATION', 'ONGOING_CREATION') OR ("databaseSchema" IS NOT NULL AND "databaseSchema" <> '')`),
    (0, _typeorm.Entity)({
        name: 'workspace',
        schema: 'core'
    }),
