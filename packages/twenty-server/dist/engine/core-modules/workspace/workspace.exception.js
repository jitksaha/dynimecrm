...
var WorkspaceExceptionCode = /*#__PURE__*/ function(WorkspaceExceptionCode) {
    ...
    WorkspaceExceptionCode["APPLICATION_UNINSTALL_IN_PROGRESS"] = "APPLICATION_UNINSTALL_IN_PROGRESS";
    return WorkspaceExceptionCode;
}({});
const getWorkspaceExceptionUserFriendlyMessage = (code)=>{
    switch(code){
        ...
        case "APPLICATION_UNINSTALL_IN_PROGRESS":
            return /*i18n*/ {
                id: "1WWVFC",
                message: "Application cleanup is still in progress. Please try again."
            };
        default:
