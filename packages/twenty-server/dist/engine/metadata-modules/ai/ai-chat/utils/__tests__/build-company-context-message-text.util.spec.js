...
const buildEnrichment = (overrides = {})=>({
        domain: 'acme.com',
...
describe('buildCompanyContextMessageText', ()=>{
    it('emits the domain and the untrusted-data framing even when everything else is null', ()=>{
        const result = (0, _buildcompanycontextmessagetextutil.buildCompanyContextMessageText)(buildEnrichment());
    ...
    it('renders the populated fields and joins the location', ()=>{
        ...
        expect(result).toContain('Location: San Francisco, California, United States');
    });
...
//# sourceMappingURL=build-company-context-message-text.util.spec.js.map