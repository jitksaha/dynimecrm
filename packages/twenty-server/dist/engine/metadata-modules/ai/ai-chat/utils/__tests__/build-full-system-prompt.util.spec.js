...
const _buildfullsystempromptutil = require("../build-full-system-prompt.util");
...
const buildPrompt = (isWorkspaceSetupThread)=>(0, _buildfullsystempromptutil.buildFullSystemPrompt)({
        toolCatalog: [],
        skillCatalog: [],
        preloadedTools: [],
...
describe('buildFullSystemPrompt', ()=>{
    it('should keep the standard composition for regular threads', ()=>{
        ...
        expect(prompt).toContain('You are a helpful AI assistant integrated into Twenty');
        ...
        expect(prompt).not.toContain('kicking off the setup of this brand-new workspace');
    });
    it('should swap in the workspace setup prompt for setup threads', ()=>{
        ...
        expect(prompt).not.toContain('You are a helpful AI assistant integrated into Twenty');
...
//# sourceMappingURL=build-full-system-prompt.util.spec.js.map