...
const _buildworkspacesetupchatthreadidutil = require("../build-workspace-setup-chat-thread-id.util");
const workspaceId = '20202020-1c25-4d02-bf25-6aeccf7ea419';
const userWorkspaceId = '20202020-9e3b-46d4-a556-88b9ddc2b034';
const THREAD_ID_ALREADY_STORED_FOR_THIS_PAIR = 'b23986d5-fd50-5d81-8bd5-311e3a4b6a0d';
describe('buildWorkspaceSetupChatThreadId', ()=>{
    it('should keep deriving the thread id already stored for existing workspaces', ()=>{
        expect((0, _buildworkspacesetupchatthreadidutil.buildWorkspaceSetupChatThreadId)({
            workspaceId,
            userWorkspaceId
    ...
    it('should give each workspace and user workspace pair its own thread id', ()=>{
        ...
        expect((0, _buildworkspacesetupchatthreadidutil.buildWorkspaceSetupChatThreadId)({
            workspaceId,
            userWorkspaceId
        })).not.toBe((0, _buildworkspacesetupchatthreadidutil.buildWorkspaceSetupChatThreadId)({
...
//# sourceMappingURL=build-workspace-setup-chat-thread-id.util.spec.js.map