...
const _gettranscriptionmodelfactoryutil = require("../get-transcription-model-factory.util");
describe('getTranscriptionModelFactory', ()=>{
    it('returns a factory for a provider exposing transcription', ()=>{
        ...
        const provider = {
            transcription: jest.fn().mockReturnValue(model)
        };
        const factory = (0, _gettranscriptionmodelfactoryutil.getTranscriptionModelFactory)(provider);
    ...
    it.each([
        [
            'a provider without the method',
            {
                languageModel: jest.fn()
            }
        ],
        [
            'a non-callable transcription property',
            {
                transcription: 'nope'
            }
        ],
        ...
        expect((0, _gettranscriptionmodelfactoryutil.getTranscriptionModelFactory)(provider)).toBeUndefined();
    });
});

//# sourceMappingURL=get-transcription-model-factory.util.spec.js.map