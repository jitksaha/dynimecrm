...
_ts_decorate([
    ...
    _ts_metadata("design:type", Object)
], CalendarChannelEntity.prototype, "webhookSubscriptionExternalId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'varchar',
        nullable: true
    ...
    _ts_metadata("design:type", Object)
], CalendarChannelEntity.prototype, "webhookSubscriptionExternalResourceId", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'varchar',
        nullable: true
    ...
    _ts_metadata("design:type", Object)
], CalendarChannelEntity.prototype, "webhookSubscriptionClientState", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'enum',
        enum: _types.WebhookSubscriptionStatus,
        nullable: true
    }),
    _ts_metadata("design:type", Object)
], CalendarChannelEntity.prototype, "webhookSubscriptionStatus", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'timestamptz',
        nullable: true
    ...
    _ts_metadata("design:type", Object)
], CalendarChannelEntity.prototype, "webhookSubscriptionExpiresAt", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        type: 'uuid',
        nullable: false
...
CalendarChannelEntity = _ts_decorate([
    ...
    (0, _typeorm.Index)('IDX_CALENDAR_CHANNEL_WEBHOOK_SUBSCRIPTION_EXTERNAL_ID', [
