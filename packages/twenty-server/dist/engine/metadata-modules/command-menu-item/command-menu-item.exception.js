...
var CommandMenuItemExceptionCode = /*#__PURE__*/ function(CommandMenuItemExceptionCode) {
    ...
    CommandMenuItemExceptionCode["COMMAND_MENU_ITEM_CANNOT_BE_RESET"] = "COMMAND_MENU_ITEM_CANNOT_BE_RESET";
    return CommandMenuItemExceptionCode;
}({});
const getCommandMenuItemExceptionUserFriendlyMessage = (code)=>{
    switch(code){
        ...
        case "COMMAND_MENU_ITEM_CANNOT_BE_RESET":
            return /*i18n*/ {
                id: "DIjcDc",
                message: "Custom command menu item cannot be reset to default."
            };
        default:
