...
let CommandMenuItemResolver = class CommandMenuItemResolver {
    async label(commandMenuItem, context, workspace) {
        return await this.commandMenuItemService.resolveTranslatedField({
            commandMenuItem,
            fieldName: 'label',
    ...
    async resetCommandMenuItem(id, workspace) {
...
_ts_decorate([
    ...
    _ts_metadata("design:returntype", Promise)
], CommandMenuItemResolver.prototype, "resetCommandMenuItem", null);
_ts_decorate([
    (0, _graphql.Mutation)(()=>_commandmenuitemdto.CommandMenuItemDTO),
    (0, _common.UseGuards)(_nopermissionguard.NoPermissionGuard),
    _ts_param(0, (0, _graphql.Args)('id', {
