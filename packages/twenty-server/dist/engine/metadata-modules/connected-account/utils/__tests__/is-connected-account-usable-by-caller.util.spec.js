...
const _isconnectedaccountusablebycallerutil = require("../is-connected-account-usable-by-caller.util");
...
describe('isConnectedAccountUsableByCaller', ()=>{
    it('accepts an account the caller owns', ()=>{
        expect((0, _isconnectedaccountusablebycallerutil.isConnectedAccountUsableByCaller)({
            connectedAccount: {
...
//# sourceMappingURL=is-connected-account-usable-by-caller.util.spec.js.map