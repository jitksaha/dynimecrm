...
const ALL_ONE_TO_MANY_METADATA_RELATIONS = {
    ...
    fieldMetadata: {
        ...
        calendarEndViews: {
            ...
            universalFlatEntityForeignKeyAggregator: 'calendarEndViewUniversalIdentifiers'
        },
        ...
        searchFieldMetadatas: {
            ...
            universalFlatEntityForeignKeyAggregator: 'searchFieldMetadataUniversalIdentifiers'
        }
    },
    objectMetadata: {
        fields: {
        ...
        commandMenuItems: {
            ...
            universalFlatEntityForeignKeyAggregator: 'commandMenuItemUniversalIdentifiers'
        }
    },
    view: {
        viewFields: {
