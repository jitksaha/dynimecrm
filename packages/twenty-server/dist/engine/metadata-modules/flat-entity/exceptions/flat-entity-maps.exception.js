...
_export(exports, {
    ...
    get flatEntityMapsExceptionContextSchema () {
        return flatEntityMapsExceptionContextSchema;
    }
});
...
const flatEntityMapsExceptionContextSchema = _zod.z.strictObject({
    universalIdentifier: _zod.z.string().optional(),
    id: _zod.z.string().optional(),
    applicationId: _zod.z.string().optional(),
    metadataName: _zod.z.string().optional(),
    relatedMetadataName: _zod.z.string().optional(),
