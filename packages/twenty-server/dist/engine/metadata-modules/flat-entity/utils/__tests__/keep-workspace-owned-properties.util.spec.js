...
const _keepworkspaceownedpropertiesutil = require("../keep-workspace-owned-properties.util");
describe('keepWorkspaceOwnedProperties', ()=>{
    ...
    it('should keep the value the workspace chose for a workspace-owned property', ()=>{
        const result = (0, _keepworkspaceownedpropertiesutil.keepWorkspaceOwnedProperties)({
        ...
        expect(result.byUniversalIdentifier['page-layout-universal-identifier']).toEqual({
            ...standardPageLayout,
            isFirstTabPinned: false
        });
    });
    it('should keep the standard value for an entity the workspace does not have yet', ()=>{
        ...
        expect(result.byUniversalIdentifier['page-layout-universal-identifier']).toEqual(standardPageLayout);
    });
...
//# sourceMappingURL=keep-workspace-owned-properties.util.spec.js.map