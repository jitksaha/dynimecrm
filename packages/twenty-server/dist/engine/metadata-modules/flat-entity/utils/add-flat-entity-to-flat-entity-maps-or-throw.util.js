...
const addFlatEntityToFlatEntityMapsOrThrow = ({ flatEntity, flatEntityMaps })=>{
    if ((0, _utils.isDefined)(flatEntityMaps.byUniversalIdentifier[flatEntity.universalIdentifier])) {
        throw new _flatentitymapsexception.FlatEntityMapsException(`addFlatEntityToFlatEntityMapsOrThrow: flat entity to add already exists (universalIdentifier: ${flatEntity.universalIdentifier})`, _flatentitymapsexception.FlatEntityMapsExceptionCode.ENTITY_ALREADY_EXISTS, {
            context: {
