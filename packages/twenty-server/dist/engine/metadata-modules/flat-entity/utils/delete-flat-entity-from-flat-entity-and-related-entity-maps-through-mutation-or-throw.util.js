...
const deleteFlatEntityFromFlatEntityAndRelatedEntityMapsThroughMutationOrThrow = ({ metadataName, flatEntity, flatEntityAndRelatedMapsToMutate })=>{
    ...
    for (const relationPropertyName of Object.keys(manyToOneRelations)){
        ...
        if (!Object.prototype.hasOwnProperty.call(relatedFlatEntity, flatEntityForeignKeyAggregator)) {
            throw new _flatentitymapsexception.FlatEntityMapsException(`Should never occur, invalid flat entity typing. flat ${relatedMetadataName} should contain ${flatEntityForeignKeyAggregator} (metadataName: ${metadataName}, universalIdentifier: ${flatEntity.universalIdentifier})`, _flatentitymapsexception.FlatEntityMapsExceptionCode.ENTITY_MALFORMED, {
                context: {
                    id: flatEntity.id,
