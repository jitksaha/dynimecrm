...
const _validatelinksflatfieldmetadatautil = require("../validators/utils/validate-links-flat-field-metadata.util");
...
const rejectUserCreation = (fieldType, message, userFriendlyMessage)=>{
    return (args)=>{
        ...
        const isCustomField = !(0, _belongstotwentystandardapputil.belongsToTwentyStandardApp)(args.flatEntityToValidate);
...
let FlatFieldMetadataTypeValidatorService = class FlatFieldMetadataTypeValidatorService {
    ...
    constructor(){
        this.FIELD_METADATA_TYPE_VALIDATOR_HASHMAP = {
            ...
            LINKS: _validatelinksflatfieldmetadatautil.validateLinksFlatFieldMetadata,
