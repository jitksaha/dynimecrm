...
const _validatenavigationmenuitemtyperequiredpropertiesutil = require("../validate-navigation-menu-item-type-required-properties.util");
...
const buildFlatNavigationMenuItem = (overrides)=>({
...
describe('validateNavigationMenuItemTypeRequiredProperties', ()=>{
    it('should return an error when type is not defined', ()=>{
        const errors = (0, _validatenavigationmenuitemtyperequiredpropertiesutil.validateNavigationMenuItemTypeRequiredProperties)({
    ...
    it.each([
        ...
        {
            type: _types.NavigationMenuItemType.LINK,
            expectedMessages: [
    ...
    ])('should report every missing property for $type type', ({ type, expectedMessages })=>{
        const errors = (0, _validatenavigationmenuitemtyperequiredpropertiesutil.validateNavigationMenuItemTypeRequiredProperties)({
            flatNavigationMenuItem: buildFlatNavigationMenuItem({
                type
            })
    ...
    it.each([
        ...
        },
        {
            type: _types.NavigationMenuItemType.OBJECT,
            overrides: {
                targetObjectMetadataUniversalIdentifier: VALID_UUID
            }
        },
        {
            type: _types.NavigationMenuItemType.VIEW,
            overrides: {
                viewUniversalIdentifier: VALID_UUID
            }
        },
        {
            type: _types.NavigationMenuItemType.RECORD,
        ...
        },
        {
            type: _types.NavigationMenuItemType.PAGE_LAYOUT,
            overrides: {
                pageLayoutUniversalIdentifier: VALID_UUID
            }
        }
    ])('should not report any error when $type type properties are valid', ({ type, overrides })=>{
        const errors = (0, _validatenavigationmenuitemtyperequiredpropertiesutil.validateNavigationMenuItemTypeRequiredProperties)({
            flatNavigationMenuItem: buildFlatNavigationMenuItem({
                type,
                ...overrides
...
//# sourceMappingURL=validate-navigation-menu-item-type-required-properties.util.spec.js.map