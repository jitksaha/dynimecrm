...
const updateMorphFlatFieldName = ({ fromMorphFlatFieldMetadata, fromRelationTargetFlatObjectMetadata, toRelationTargetFlatObjectMetadata })=>{
    ...
    const newLabel = fromMorphFlatFieldMetadata.isSystemSideEffect === true ? (0, _utils.capitalize)(toRelationTargetFlatObjectMetadata.nameSingular) : fromMorphFlatFieldMetadata.label;
    return {
...
const renameRelatedMorphFieldOnObjectNamesUpdate = ({ fromFlatObjectMetadata, toFlatObjectMetadata, flatFieldMetadataMaps, flatObjectMetadataMaps, flatIndexMaps, systemSideEffectMorphFieldsOnly })=>{
    ...
    }).filter((morphFlatFieldMetadata)=>morphFlatFieldMetadata.isSystemSideEffect === true === systemSideEffectMorphFieldsOnly);
