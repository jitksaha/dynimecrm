...
let FlatPageLayoutWidgetTypeValidatorService = class FlatPageLayoutWidgetTypeValidatorService {
    ...
    constructor(){
        this.PAGE_LAYOUT_WIDGET_TYPE_VALIDATOR_FOR_CREATION_HASHMAP = {
            VIEW: (0, _rejectwidgettypeutil.rejectWidgetType)(_types.WidgetType.VIEW, 'Widget type VIEW is not supported yet.', /*i18n*/ {
                id: "rL2haJ",
            ...
            CALL_RECORDING_SUMMARY: (0, _validatesimplerecordpagewidgetforcreationutil.validateSimpleRecordPageWidgetForCreation)(_widgetconfigurationtypetype.WidgetConfigurationType.CALL_RECORDING_SUMMARY),
            CALL_RECORDING_TRANSCRIPT: (0, _validatesimplerecordpagewidgetforcreationutil.validateSimpleRecordPageWidgetForCreation)(_widgetconfigurationtypetype.WidgetConfigurationType.CALL_RECORDING_TRANSCRIPT),
            MESSAGE_CAMPAIGN_BODY: (0, _validatesimplerecordpagewidgetforcreationutil.validateSimpleRecordPageWidgetForCreation)(_widgetconfigurationtypetype.WidgetConfigurationType.MESSAGE_CAMPAIGN_BODY),
            MESSAGE_CAMPAIGN_DETAILS: (0, _validatesimplerecordpagewidgetforcreationutil.validateSimpleRecordPageWidgetForCreation)(_widgetconfigurationtypetype.WidgetConfigurationType.MESSAGE_CAMPAIGN_DETAILS),
            FORM_FIELD: (0, _validatesimplerecordpagewidgetforcreationutil.validateSimpleRecordPageWidgetForCreation)(_widgetconfigurationtypetype.WidgetConfigurationType.FORM_FIELD)
        };
        this.PAGE_LAYOUT_WIDGET_TYPE_VALIDATOR_FOR_UPDATE_HASHMAP = {
            ...
            CALL_RECORDING_SUMMARY: (0, _validatesimplerecordpagewidgetforupdateutil.validateSimpleRecordPageWidgetForUpdate)(_widgetconfigurationtypetype.WidgetConfigurationType.CALL_RECORDING_SUMMARY),
            CALL_RECORDING_TRANSCRIPT: (0, _validatesimplerecordpagewidgetforupdateutil.validateSimpleRecordPageWidgetForUpdate)(_widgetconfigurationtypetype.WidgetConfigurationType.CALL_RECORDING_TRANSCRIPT),
            MESSAGE_CAMPAIGN_BODY: (0, _validatesimplerecordpagewidgetforupdateutil.validateSimpleRecordPageWidgetForUpdate)(_widgetconfigurationtypetype.WidgetConfigurationType.MESSAGE_CAMPAIGN_BODY),
            MESSAGE_CAMPAIGN_DETAILS: (0, _validatesimplerecordpagewidgetforupdateutil.validateSimpleRecordPageWidgetForUpdate)(_widgetconfigurationtypetype.WidgetConfigurationType.MESSAGE_CAMPAIGN_DETAILS),
            FORM_FIELD: (0, _validatesimplerecordpagewidgetforupdateutil.validateSimpleRecordPageWidgetForUpdate)(_widgetconfigurationtypetype.WidgetConfigurationType.FORM_FIELD)
        };
    }
};
