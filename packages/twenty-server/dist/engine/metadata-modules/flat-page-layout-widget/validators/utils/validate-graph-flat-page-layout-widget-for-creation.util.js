...
const validateGraphFlatPageLayoutWidgetForCreation = (args)=>{
    const { flatEntityToValidate, optimisticFlatEntityMapsAndRelatedFlatEntityMaps } = args;
    ...
    const chartFilterErrors = (0, _validatechartfilterutil.validateChartFilter)({
        filter: graphUniversalConfiguration.filter,
        widgetTitle,
        flatFieldMetadataMaps: optimisticFlatEntityMapsAndRelatedFlatEntityMaps.flatFieldMetadataMaps
    });
