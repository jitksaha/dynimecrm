...
const _createsearchfieldmetadatasbytsvectorfieldidaccessorutil = require("../create-search-field-metadatas-by-ts-vector-field-id-accessor.util");
const buildFlatSearchFieldMetadata = (universalIdentifier, tsVectorFieldMetadataId)=>({
...
describe('createSearchFieldMetadatasByTsVectorFieldIdAccessor', ()=>{
    it('resolves the search fields for a tsVector field', ()=>{
        ...
        const accessor = (0, _createsearchfieldmetadatasbytsvectorfieldidaccessorutil.createSearchFieldMetadatasByTsVectorFieldIdAccessor)(()=>maps);
    ...
    it('serves a stale result after the map changes until invalidate() is called', ()=>{
        ...
        maps.byUniversalIdentifier['a2'] = buildFlatSearchFieldMetadata('a2', 'ts-vector-a');
        expect(accessor.get('ts-vector-a')).toHaveLength(1);
        accessor.invalidate();
        expect(accessor.get('ts-vector-a')).toHaveLength(2);
    });
...
//# sourceMappingURL=create-search-field-metadatas-by-ts-vector-field-id-accessor.util.spec.js.map