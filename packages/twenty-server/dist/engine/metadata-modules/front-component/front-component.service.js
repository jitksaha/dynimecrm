...
const _getcontentdispositionutils = require("../../core-modules/file/utils/get-content-disposition.utils");
...
let FrontComponentService = class FrontComponentService {
    ...
    async getBuiltComponentPresignedUrlOrStream({ frontComponentId, workspaceId }) {
    ...
    constructor(workspaceMigrationValidateBuildAndRunService, workspaceManyOrAllFlatEntityMapsCacheService, applicationService, fileStorageService, twentyConfigService){
