...
describe('computeUniqueFieldMetadataIdsFromIndexes', ()=>{
    it('includes a field backed by a single-column system-side-effect unique index', ()=>{
        const result = (0, _computeuniquefieldmetadataidsfromindexesutil.computeUniqueFieldMetadataIdsFromIndexes)([
            {
                isUnique: true,
                isSystemSideEffect: true,
                flatIndexFieldMetadatas: [
                    {
                        fieldMetadataId: FIELD_A,
                        subFieldName: null
                    }
                ]
            }
...
//# sourceMappingURL=compute-unique-field-metadata-ids-from-indexes.util.spec.js.map