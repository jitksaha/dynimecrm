...
const _aiworkspacestatsmodule = require("./ai/ai-workspace-stats/ai-workspace-stats.module");
const _applicationconnectionsmodule = require("../core-modules/application/connection-provider/connections/application-connections.module");
const _applicationjobmodule = require("../core-modules/application/application-job/application-job.module");
const _applicationkeyvaluemodule = require("../core-modules/application/application-key-value/application-key-value.module");
...
const _metadatatranslationmodule = require("./metadata-translation/metadata-translation.module");
const _navigationmenuitemmodule = require("./navigation-menu-item/navigation-menu-item.module");
const _timelineactivitytypemodule = require("./timeline-activity-type/timeline-activity-type.module");
...
const _serverroutetriggermodule = require("../core-modules/server-route-trigger/server-route-trigger.module");
...
MetadataEngineModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
            ...
            _metadatatranslationmodule.MetadataTranslationModule,
            _navigationmenuitemmodule.NavigationMenuItemModule,
            _timelineactivitytypemodule.TimelineActivityTypeModule,
            ...
            _aiworkspacestatsmodule.AiWorkspaceStatsModule,
            _applicationconnectionsmodule.ApplicationConnectionsModule,
            _applicationjobmodule.ApplicationJobModule,
            _applicationkeyvaluemodule.ApplicationKeyValueModule,
            ...
            _serverroutetriggermodule.ServerRouteTriggerModule,
