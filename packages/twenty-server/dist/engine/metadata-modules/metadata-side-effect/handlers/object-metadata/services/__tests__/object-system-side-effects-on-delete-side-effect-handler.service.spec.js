...
const _objectsystemsideeffectsondeletesideeffecthandlerservice = require("../object-system-side-effects-on-delete-side-effect-handler.service");
...
const OTHER_OBJECT_UNIVERSAL_IDENTIFIER = 'c1c2c3c4-c5c6-4000-8000-000000000001';
const OTHER_OBJECT_ID = 'b0b0b0b0-b0b0-4000-8000-000000000002';
const SYSTEM_FIELD_UNIVERSAL_IDENTIFIER = 'd1d2d3d4-d5d6-4000-8000-000000000001';
const AUTHOR_FIELD_UNIVERSAL_IDENTIFIER = 'd1d2d3d4-d5d6-4000-8000-000000000002';
const FORWARD_FIELD_UNIVERSAL_IDENTIFIER = 'd1d2d3d4-d5d6-4000-8000-000000000003';
const REVERSE_FIELD_UNIVERSAL_IDENTIFIER = 'd1d2d3d4-d5d6-4000-8000-000000000004';
const GIN_INDEX_UNIVERSAL_IDENTIFIER = 'e1e2e3e4-e5e6-4000-8000-000000000001';
const REVERSE_INDEX_UNIVERSAL_IDENTIFIER = 'e1e2e3e4-e5e6-4000-8000-000000000002';
const SEARCH_FIELD_METADATA_UNIVERSAL_IDENTIFIER = 'f1f2f3f4-f5f6-4000-8000-000000000001';
const INDEX_VIEW_UNIVERSAL_IDENTIFIER = 'a1a2a3a4-a5a6-4000-8000-000000000001';
const INDEX_VIEW_FIELD_UNIVERSAL_IDENTIFIER = 'a1a2a3a4-a5a6-4000-8000-000000000002';
const CALLER_VIEW_UNIVERSAL_IDENTIFIER = 'a1a2a3a4-a5a6-4000-8000-000000000003';
const CALLER_VIEW_FIELD_UNIVERSAL_IDENTIFIER = 'a1a2a3a4-a5a6-4000-8000-000000000004';
const buildFieldMetadataMaps = (fields)=>({
...
const buildArgs = ({ fieldUniversalIdentifiers = [], indexMetadataUniversalIdentifiers = [], searchFieldMetadataUniversalIdentifiers = [], viewUniversalIdentifiers = [], pageLayoutUniversalIdentifiers = [], commandMenuItemUniversalIdentifiers = [], relatedFlatEntityMaps = {} })=>({
        flatEntity: {
            id: OBJECT_ID,
...
describe('ObjectSystemSideEffectsOnDeleteSideEffectHandlerService', ()=>{
    const handler = new _objectsystemsideeffectsondeletesideeffecthandlerservice.ObjectSystemSideEffectsOnDeleteSideEffectHandlerService();
    it('should cascade-delete engine-owned fields, indexes and searchFieldMetadata while leaving author fields untouched', ()=>{
        ...
        const deletedFieldUniversalIdentifiers = Object.keys(result.operations.fieldMetadata?.flatEntityToDelete ?? {});
        expect(deletedFieldUniversalIdentifiers).toEqual([
            SYSTEM_FIELD_UNIVERSAL_IDENTIFIER
        ]);
        expect(deletedFieldUniversalIdentifiers).not.toContain(AUTHOR_FIELD_UNIVERSAL_IDENTIFIER);
        expect(Object.keys(result.operations.index?.flatEntityToDelete ?? {})).toEqual([
            GIN_INDEX_UNIVERSAL_IDENTIFIER
        ]);
        expect(Object.keys(result.operations.searchFieldMetadata?.flatEntityToDelete ?? {})).toEqual([
            SEARCH_FIELD_METADATA_UNIVERSAL_IDENTIFIER
        ]);
    });
    it('should cascade-delete the default-relation reverse morph field on a standard object and its join-column index', ()=>{
                ...
                flatFieldMetadataMaps: buildFieldMetadataMaps([
                    {
                        ...
                        isSystemSideEffect: true,
                        relationTargetFieldMetadataUniversalIdentifier: REVERSE_FIELD_UNIVERSAL_IDENTIFIER
                    },
                    {
        ...
        expect(Object.keys(result.operations.fieldMetadata?.flatEntityToDelete ?? {})).toEqual([
            FORWARD_FIELD_UNIVERSAL_IDENTIFIER,
    ...
    it('should cascade-delete the engine-owned INDEX view and its view fields while leaving a caller-owned view untouched', ()=>{
        ...
        expect(Object.keys(result.operations.view?.flatEntityToDelete ?? {})).toEqual([
            INDEX_VIEW_UNIVERSAL_IDENTIFIER
        ]);
        expect(Object.keys(result.operations.viewField?.flatEntityToDelete ?? {})).toEqual([
            INDEX_VIEW_FIELD_UNIVERSAL_IDENTIFIER
        ]);
    });
    it('should cascade-delete a system view field of a deleted field even when it lives on another object view', ()=>{
        const OTHER_OBJECT_VIEW_FIELD_UNIVERSAL_IDENTIFIER = 'a1a2a3a4-a5a6-4000-8000-000000000006';
        const result = handler.buildSideEffects(buildArgs({
            fieldUniversalIdentifiers: [
                FORWARD_FIELD_UNIVERSAL_IDENTIFIER
            ],
            relatedFlatEntityMaps: {
                ...
                flatViewFieldMaps: {
                    byUniversalIdentifier: {
                        [OTHER_OBJECT_VIEW_FIELD_UNIVERSAL_IDENTIFIER]: {
                            universalIdentifier: OTHER_OBJECT_VIEW_FIELD_UNIVERSAL_IDENTIFIER,
                            isSystemSideEffect: true
                        }
                    }
                }
    ...
    it('should cascade-delete the engine-owned navigation command from the object aggregator, whatever its identifier', ()=>{
        ...
        expect(Object.keys(result.operations.commandMenuItem?.flatEntityToDelete ?? {})).toEqual([
            'legacy-navigation-command-identifier'
        ]);
    });
                ...
                flatCommandMenuItemMaps: {
                    byUniversalIdentifier: {
                        ...
                        'other-object-navigation-identifier': {
                            ...
                            engineComponentKey: _enginecomponentkeyenum.EngineComponentKey.NAVIGATION,
                            payload: {
                                objectMetadataItemId: OTHER_OBJECT_ID
                            }
                        }
                    }
                }
...
//# sourceMappingURL=object-system-side-effects-on-delete-side-effect-handler.service.spec.js.map