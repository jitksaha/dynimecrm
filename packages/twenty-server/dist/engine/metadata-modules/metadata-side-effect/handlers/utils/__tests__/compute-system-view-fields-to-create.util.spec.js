...
describe('computeSystemViewFieldsToCreate', ()=>{
    it('should exclude TS_VECTOR fields', ()=>{
        ...
        const result = (0, _computesystemviewfieldstocreateutil.computeSystemViewFieldsToCreate)({
    ...
    it('should derive the view field universal identifier deterministically', ()=>{
        ...
        expect(result[0].universalIdentifier).toBe((0, _application.getViewFieldUniversalIdentifier)({
            applicationUniversalIdentifier,
            viewUniversalIdentifier,
...
//# sourceMappingURL=compute-system-view-fields-to-create.util.spec.js.map