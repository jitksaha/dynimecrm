...
let NavigationMenuItemResolver = class NavigationMenuItemResolver {
    async name(navigationMenuItem, context, workspace) {
        if (!(0, _guards.isNonEmptyString)(navigationMenuItem.name)) {
    ...
    constructor(navigationMenuItemService, applicationTranslationCatalogService){
...
], NavigationMenuItemResolver.prototype, "name", null);
_ts_decorate([
    (0, _graphql.Query)(()=>[
