...
Object.defineProperty(exports, "ObjectMetadataRestApiExceptionFilter", {
    enumerable: true,
    get: function() {
        return ObjectMetadataRestApiExceptionFilter;
    }
});
...
const _objectmetadataexceptioncodetohttpstatusutil = require("../utils/object-metadata-exception-code-to-http-status.util");
...
let ObjectMetadataRestApiExceptionFilter = class ObjectMetadataRestApiExceptionFilter {
        ...
        if (exception instanceof _objectmetadataexception.ObjectMetadataException) {
            return this.httpExceptionHandlerService.handleError(exception, response, (0, _objectmetadataexceptioncodetohttpstatusutil.objectMetadataExceptionCodeToHttpStatus)(exception.code));
        }
...
ObjectMetadataRestApiExceptionFilter = _ts_decorate([
    (0, _common.Injectable)(),
    (0, _common.Catch)(_objectmetadataexception.ObjectMetadataException, _invalidmetadataexception.InvalidMetadataException, _workspacemigrationbuilderexception.WorkspaceMigrationBuilderException, _restinputrequestparserexception.RestInputRequestParserException, _flatentitymapsexception.FlatEntityMapsException),
...
//# sourceMappingURL=object-metadata-rest-api-exception.filter.js.map