...
const _orderflatfieldmetadatasforsystemindexviewutil = require("../order-flat-field-metadatas-for-system-index-view.util");
const NAME = {
...
const CREATED_BY = {
    universalIdentifier: 'created-by-uid'
};
describe('orderFlatFieldMetadatasForSystemIndexView', ()=>{
    it('should move the label identifier first when it is not already', ()=>{
        expect((0, _orderflatfieldmetadatasforsystemindexviewutil.orderFlatFieldMetadatasForSystemIndexView)({
            flatFieldMetadatas: [
                CREATED_AT,
                NAME,
                CREATED_BY
    ...
    it('should not mutate the input array', ()=>{
        ...
        (0, _orderflatfieldmetadatasforsystemindexviewutil.orderFlatFieldMetadatasForSystemIndexView)({
            flatFieldMetadatas,
            labelIdentifierFieldMetadataUniversalIdentifier: 'name-uid'
        });
        expect(flatFieldMetadatas).toEqual([
            CREATED_AT,
            NAME
        ]);
    });
...
//# sourceMappingURL=order-flat-field-metadatas-for-system-index-view.util.spec.js.map