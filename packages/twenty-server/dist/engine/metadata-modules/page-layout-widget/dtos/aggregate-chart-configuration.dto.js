...
const _chartnumberformatenum = require("../enums/chart-number-format.enum");
...
_ts_decorate([
    (0, _graphql.Field)(()=>_chartnumberformatenum.ChartNumberFormat, {
        nullable: true
    }),
    (0, _classvalidator.IsEnum)(_chartnumberformatenum.ChartNumberFormat),
    (0, _classvalidator.IsOptional)(),
    _ts_metadata("design:type", typeof _chartnumberformatenum.ChartNumberFormat === "undefined" ? Object : _chartnumberformatenum.ChartNumberFormat)
], AggregateChartConfigurationDTO.prototype, "numberFormat", void 0);
_ts_decorate([
    (0, _graphql.Field)(()=>String, {
        nullable: true
    }),
