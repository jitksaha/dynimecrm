...
var WidgetConfigurationType = function(WidgetConfigurationType) {
    ...
    WidgetConfigurationType["CALL_RECORDING_SUMMARY"] = "CALL_RECORDING_SUMMARY";
    WidgetConfigurationType["CALL_RECORDING_TRANSCRIPT"] = "CALL_RECORDING_TRANSCRIPT";
    WidgetConfigurationType["MESSAGE_CAMPAIGN_BODY"] = "MESSAGE_CAMPAIGN_BODY";
    WidgetConfigurationType["MESSAGE_CAMPAIGN_DETAILS"] = "MESSAGE_CAMPAIGN_DETAILS";
    WidgetConfigurationType["FORM_FIELD"] = "FORM_FIELD";
    return WidgetConfigurationType;
}({});
