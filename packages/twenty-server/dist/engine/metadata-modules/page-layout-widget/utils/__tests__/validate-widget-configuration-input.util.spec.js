...
describe('validateWidgetConfigurationInput', ()=>{
    describe('EMAIL_THREAD widget', ()=>{
        it('should not throw for valid email thread configuration', ()=>{
            expect(()=>(0, _validatewidgetconfigurationinpututil.validateWidgetConfigurationInput)({
                    configuration: {
                        configurationType: _widgetconfigurationtypetype.WidgetConfigurationType.EMAIL_THREAD
                    }
                })).not.toThrow();
        });
    });
    describe('MESSAGE_CAMPAIGN_BODY widget', ()=>{
        it('should not throw for valid message campaign body configuration', ()=>{
            expect(()=>(0, _validatewidgetconfigurationinpututil.validateWidgetConfigurationInput)({
                    configuration: {
                        configurationType: _widgetconfigurationtypetype.WidgetConfigurationType.MESSAGE_CAMPAIGN_BODY
                    }
                })).not.toThrow();
        });
    });
    describe('MESSAGE_CAMPAIGN_DETAILS widget', ()=>{
        it('should not throw for valid message campaign details configuration', ()=>{
            expect(()=>(0, _validatewidgetconfigurationinpututil.validateWidgetConfigurationInput)({
                    configuration: {
                        configurationType: _widgetconfigurationtypetype.WidgetConfigurationType.MESSAGE_CAMPAIGN_DETAILS
                    }
                })).not.toThrow();
        });
    });
