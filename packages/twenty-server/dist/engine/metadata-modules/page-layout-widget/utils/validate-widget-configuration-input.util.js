...
const _callrecordingsummaryconfigurationdto = require("../dtos/call-recording-summary-configuration.dto");
const _callrecordingtranscriptconfigurationdto = require("../dtos/call-recording-transcript-configuration.dto");
const _emailthreadconfigurationdto = require("../dtos/email-thread-configuration.dto");
const _formfieldconfigurationdto = require("../dtos/form-field-configuration.dto");
...
const _messagecampaignbodyconfigurationdto = require("../dtos/message-campaign-body-configuration.dto");
const _messagecampaigndetailsconfigurationdto = require("../dtos/message-campaign-details-configuration.dto");
...
const validateWidgetConfigurationInput = ({ configuration })=>{
    ...
    switch(configurationType){
        ...
        case _widgetconfigurationtypetype.WidgetConfigurationType.EMAIL_THREAD:
            errors = (0, _validatewidgetconfigurationbydtoutil.validateWidgetConfigurationByDto)(_emailthreadconfigurationdto.EmailThreadConfigurationDTO, configuration);
            break;
        case _widgetconfigurationtypetype.WidgetConfigurationType.CALL_RECORDING_SUMMARY:
            errors = (0, _validatewidgetconfigurationbydtoutil.validateWidgetConfigurationByDto)(_callrecordingsummaryconfigurationdto.CallRecordingSummaryConfigurationDTO, configuration);
            break;
        case _widgetconfigurationtypetype.WidgetConfigurationType.CALL_RECORDING_TRANSCRIPT:
            errors = (0, _validatewidgetconfigurationbydtoutil.validateWidgetConfigurationByDto)(_callrecordingtranscriptconfigurationdto.CallRecordingTranscriptConfigurationDTO, configuration);
            break;
        case _widgetconfigurationtypetype.WidgetConfigurationType.MESSAGE_CAMPAIGN_BODY:
            errors = (0, _validatewidgetconfigurationbydtoutil.validateWidgetConfigurationByDto)(_messagecampaignbodyconfigurationdto.MessageCampaignBodyConfigurationDTO, configuration);
            break;
        case _widgetconfigurationtypetype.WidgetConfigurationType.MESSAGE_CAMPAIGN_DETAILS:
            errors = (0, _validatewidgetconfigurationbydtoutil.validateWidgetConfigurationByDto)(_messagecampaigndetailsconfigurationdto.MessageCampaignDetailsConfigurationDTO, configuration);
            break;
        ...
        case _widgetconfigurationtypetype.WidgetConfigurationType.FORM_FIELD:
            errors = (0, _validatewidgetconfigurationbydtoutil.validateWidgetConfigurationByDto)(_formfieldconfigurationdto.FormFieldConfigurationDTO, configuration);
            break;
