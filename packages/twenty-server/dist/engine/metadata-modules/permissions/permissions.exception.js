...
var PermissionsExceptionCode = /*#__PURE__*/ function(PermissionsExceptionCode) {
    ...
    PermissionsExceptionCode["CANNOT_DELETE_OWN_ROLE"] = "CANNOT_DELETE_OWN_ROLE";
    PermissionsExceptionCode["CANNOT_REVOKE_OWN_SETTINGS_ACCESS"] = "CANNOT_REVOKE_OWN_SETTINGS_ACCESS";
...
const getPermissionsExceptionUserFriendlyMessage = (code)=>{
    switch(code){
        ...
        case "CANNOT_DELETE_OWN_ROLE":
            return /*i18n*/ {
                id: "xqrB9X",
                message: "You cannot delete a role you are assigned to. Ask another administrator to delete it."
            };
        case "CANNOT_REVOKE_OWN_SETTINGS_ACCESS":
            return /*i18n*/ {
                id: "KcnT7Q",
                message: "You cannot remove settings access from your own role. Ask another administrator to make this change."
            };
...
var PermissionsExceptionMessage = /*#__PURE__*/ function(PermissionsExceptionMessage) {
    ...
    PermissionsExceptionMessage["CANNOT_DELETE_OWN_ROLE"] = "Cannot delete a role assigned to the acting user";
    PermissionsExceptionMessage["CANNOT_REVOKE_OWN_SETTINGS_ACCESS"] = "Cannot revoke settings access from the acting user role";
