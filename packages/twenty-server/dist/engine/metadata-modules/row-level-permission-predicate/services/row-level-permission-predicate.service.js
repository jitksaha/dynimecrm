...
const _validaterowlevelpermissionruleownershiputil = require("../utils/validate-row-level-permission-rule-ownership.util");
...
let RowLevelPermissionPredicateService = class RowLevelPermissionPredicateService {
    ...
    async upsertRowLevelPermissionPredicates({ input, workspaceId }) {
        ...
        (0, _validaterowlevelpermissionruleownershiputil.validateRowLevelPermissionRuleOwnershipOrThrow)({
            roleId,
            objectMetadataId,
            predicates,
            predicateGroups,
            ...
            flatRowLevelPermissionPredicateGroupMaps,
            flatFieldMetadataMaps,
            workspaceMemberObjectMetadataId: (0, _buildobjectidbynamemapsutil.buildObjectIdByNameMaps)(flatObjectMetadataMaps).idByNameSingular.workspaceMember
        });
