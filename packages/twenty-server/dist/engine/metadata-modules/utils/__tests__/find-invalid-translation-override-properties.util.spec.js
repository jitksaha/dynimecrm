...
const _findinvalidtranslationoverridepropertiesutil = require("../find-invalid-translation-override-properties.util");
describe('findInvalidTranslationOverrideProperties', ()=>{
    it('returns nothing when every property is translatable', ()=>{
        expect((0, _findinvalidtranslationoverridepropertiesutil.findInvalidTranslationOverrideProperties)([
            {
                locale: 'fr-FR',
    ...
    it('returns nothing when there is no entry at all', ()=>{
        expect((0, _findinvalidtranslationoverridepropertiesutil.findInvalidTranslationOverrideProperties)([], 'objectMetadata')).toEqual([]);
    });
...
//# sourceMappingURL=find-invalid-translation-override-properties.util.spec.js.map