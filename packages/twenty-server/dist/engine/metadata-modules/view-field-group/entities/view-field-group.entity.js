...
const _addissystemsideeffecttoviewfieldgroupupgradecommandnameconstant = require("../../../../database/commands/upgrade-version-command/2-31/add-is-system-side-effect-to-view-field-group-upgrade-command-name.constant");
...
_ts_decorate([
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: _addissystemsideeffecttoviewfieldgroupupgradecommandnameconstant.ADD_IS_SYSTEM_SIDE_EFFECT_TO_VIEW_FIELD_GROUP_UPGRADE_COMMAND_NAME
    }),
    (0, _typeorm.Column)({
        nullable: false,
        default: false,
    ...
    _ts_metadata("design:type", Boolean)
], ViewFieldGroupEntity.prototype, "isSystemSideEffect", void 0);
_ts_decorate([
