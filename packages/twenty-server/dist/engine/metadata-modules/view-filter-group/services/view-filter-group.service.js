...
let ViewFilterGroupService = class ViewFilterGroupService {
    ...
    async findById(id, workspaceId) {
        const viewFilterGroup = await this.viewFilterGroupRepository.findOne(workspaceId, {
            where: {
                id,
                deletedAt: (0, _typeorm.IsNull)()
            },
...
ViewFilterGroupService = _ts_decorate([
    ...
    _ts_param(0, (0, _injectworkspacescopedrepositorydecorator.InjectWorkspaceScopedRepository)(_viewfiltergroupentity.ViewFilterGroupEntity)),
