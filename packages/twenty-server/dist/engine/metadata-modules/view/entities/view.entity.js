...
const _addviewkanbancolumnwidthupgradecommandnameconstant = require("../../../../database/commands/upgrade-version-command/2-15/add-view-kanban-column-width-upgrade-command-name.constant");
const _addcalendarendfieldmetadataidtoviewupgradecommandnameconstant = require("../../../../database/commands/upgrade-version-command/2-22/add-calendar-end-field-metadata-id-to-view-upgrade-command-name.constant");
...
let ViewEntity = class ViewEntity extends _overridableentity.OverridableEntity {
};
_ts_decorate([
...
_ts_decorate([
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: _addcalendarendfieldmetadataidtoviewupgradecommandnameconstant.ADD_CALENDAR_END_FIELD_METADATA_ID_TO_VIEW_UPGRADE_COMMAND_NAME
    }),
    (0, _typeorm.Column)({
        nullable: true,
        type: 'uuid'
    ...
    _ts_metadata("design:type", Object)
], ViewEntity.prototype, "calendarEndFieldMetadataId", void 0);
_ts_decorate([
    (0, _typeorm.ManyToOne)(()=>_fieldmetadataentity.FieldMetadataEntity, (fieldMetadata)=>fieldMetadata.calendarEndViews, {
        onDelete: 'SET NULL',
        nullable: true
    }),
    (0, _typeorm.JoinColumn)({
        name: 'calendarEndFieldMetadataId'
    }),
    _ts_metadata("design:type", Object)
], ViewEntity.prototype, "calendarEndFieldMetadata", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true,
        type: 'uuid'
...
_ts_decorate([
    (0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
        upgradeCommandName: _addviewkanbancolumnwidthupgradecommandnameconstant.ADD_VIEW_KANBAN_COLUMN_WIDTH_UPGRADE_COMMAND_NAME
    }),
    (0, _typeorm.Column)({
        nullable: true,
        type: 'int',
    ...
    _ts_metadata("design:type", Object)
], ViewEntity.prototype, "kanbanColumnWidth", void 0);
_ts_decorate([
...
_ts_decorate([
    ...
    _ts_metadata("design:type", Boolean)
], ViewEntity.prototype, "isSystemSideEffect", void 0);
_ts_decorate([
    (0, _typeorm.Column)({
        nullable: true,
        type: 'uuid'
...
ViewEntity = _ts_decorate([
    ...
    (0, _typeorm.Index)('IDX_VIEW_CALENDAR_END_FIELD_METADATA', [
    ...
    (0, _typeorm.Check)('CHK_VIEW_CALENDAR_INTEGRITY', `("type" NOT IN ('CALENDAR', 'CALENDAR_WIDGET') OR ("calendarLayout" IS NOT NULL AND "calendarFieldMetadataId" IS NOT NULL))`)
], ViewEntity);
const VIEW_OVERRIDABLE_COLUMNS_UPGRADE_COMMAND_NAME = '2.12.0_ViewOverridableEntityFastInstanceCommand_1781114009075';
(0, _wasintroducedinupgradedecorator.WasIntroducedInUpgrade)({
