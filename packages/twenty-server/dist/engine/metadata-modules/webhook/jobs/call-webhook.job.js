...
const _eventlogemitterservice = require("../../../core-modules/event-logs/emit/event-log-emitter.service");
const _webhookresponse = require("../../../core-modules/event-logs/emit/events/workspace-event/webhook/webhook-response");
...
let CallWebhookJob = class CallWebhookJob {
    ...
    async callWebhook(data) {
        ...
        try {
            ...
            void eventLogContext.insertWorkspaceEvent(_webhookresponse.WEBHOOK_RESPONSE_EVENT, {
    ...
    constructor(eventLogEmitterService, metricsService, secureHttpClientService){
