...
const _filestatustypes = require("../../../core-modules/file/types/file-status.types");
        ...
        for (const entityDiffs of Object.values(filesFieldDiffByEntityIndex)){
            for (const diff of Object.values(entityDiffs)){
                for (const file of diff.toAdd){
                    ...
                    if (fileEntity.status !== _filestatustypes.FILE_STATUS.UPLOADED) {
                        const fileId = file.fileId;
                        throw new _twentyormexception.TwentyOrmException(`File ${fileId} upload has not been completed`, _twentyormexception.TwentyOrmExceptionCode.INVALID_INPUT, {
                            userFriendlyMessage: /*i18n*/ {
                                id: "xiXoMW",
                                message: "File {fileId} upload has not been completed. Please retry the upload.",
                                values: {
                                    fileId: fileId
                                }
                            }
