...
const _mergerecordswithupdatevaluesutil = require("../merge-records-with-update-values.util");
describe('mergeRecordsWithUpdateValues', ()=>{
    it('merges shared concrete values into every record', ()=>{
        expect((0, _mergerecordswithupdatevaluesutil.mergeRecordsWithUpdateValues)([
            {
                id: 'first',
                name: 'First'
            },
    ...
    it('ignores raw SQL function values', ()=>{
        expect((0, _mergerecordswithupdatevaluesutil.mergeRecordWithUpdateValues)({
            id: 'first',
            name: 'First',
    ...
    it('returns the original record when values are missing', ()=>{
        ...
        expect((0, _mergerecordswithupdatevaluesutil.mergeRecordWithUpdateValues)(record, undefined)).toBe(record);
    });
});
describe('getUpdateEventRecords', ()=>{
    it('matches post-write records to pre-write records by id', ()=>{
        expect((0, _mergerecordswithupdatevaluesutil.getUpdateEventRecords)([
            {
                id: 'first',
                name: 'First before'
            },
...
//# sourceMappingURL=merge-records-with-update-values.util.spec.js.map