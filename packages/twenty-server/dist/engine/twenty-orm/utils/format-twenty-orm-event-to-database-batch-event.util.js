        ...
        case _databaseeventaction.DatabaseEventAction.RESTORED:
            {
                ...
                events = recordsAfter.map((recordAfter)=>{
                    ...
                    const updatedFields = (0, _objectrecordchangedvalues.computeUpdatedFieldsFromDiff)(diff, objectMetadataItem, flatFieldMetadataMaps);
        ...
        case _databaseeventaction.DatabaseEventAction.UPSERTED:
            {
                ...
                events = recordsAfter.map((recordAfter)=>{
                    ...
                    updatedFields = (0, _objectrecordchangedvalues.computeUpdatedFieldsFromDiff)(diff, objectMetadataItem, flatFieldMetadataMaps);
                    event.properties = {
                        after: recordAfter,
