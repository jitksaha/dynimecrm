...
const _companydataseedsconstant = require("../../data/constants/company-data-seeds.constant");
...
const seedChatMessages = async ({ queryRunner, schemaName, workspaceId, threadId, chatReferenceIds })=>{
    let messageIds;
    let partIds;
    let turnIds;
    let messages;
        ...
        messageParts = [
            {
                ...
                orderIndex: 0,
                type: 'text',
                textContent: 'Can you show me examples of everything I can open from AI chat?',
                createdAt: new Date(baseTime.getTime())
            },
            {
                id: partIds[1],
...
const seedAgents = async ({ queryRunner, schemaName, workspaceId, chatReferenceIds })=>{
