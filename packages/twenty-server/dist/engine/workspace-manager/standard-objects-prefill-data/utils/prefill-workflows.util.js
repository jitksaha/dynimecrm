...
_export(exports, {
    get getWorkflowPrefillIds () {
        return getWorkflowPrefillIds;
    },
...
const getWorkflowPrefillIds = (workspaceId)=>({
        quickLeadWorkflowId: (0, _uuid.v5)(`quickLeadWorkflow:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        quickLeadWorkflowVersionId: (0, _uuid.v5)(`quickLeadWorkflowVersion:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        createCompanyWorkflowId: (0, _uuid.v5)(`createCompanyWorkflow:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        createCompanyWorkflowVersionId: (0, _uuid.v5)(`createCompanyWorkflowVersion:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        createCompanyAutomatedTriggerId: (0, _uuid.v5)(`createCompanyAutomatedTrigger:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        coreQuickLeadWorkflowId: (0, _uuid.v5)(`coreQuickLeadWorkflow:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        coreCreateCompanyWorkflowId: (0, _uuid.v5)(`coreCreateCompanyWorkflow:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        coreQuickLeadWorkflowVersionId: (0, _uuid.v5)(`coreQuickLeadWorkflowVersion:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        coreCreateCompanyWorkflowVersionId: (0, _uuid.v5)(`coreCreateCompanyWorkflowVersion:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        quickLeadWorkflowUniversalIdentifier: (0, _uuid.v5)(`quickLeadWorkflowUniversalIdentifier:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        createCompanyWorkflowUniversalIdentifier: (0, _uuid.v5)(`createCompanyWorkflowUniversalIdentifier:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        quickLeadWorkflowVersionUniversalIdentifier: (0, _uuid.v5)(`quickLeadWorkflowVersionUniversalIdentifier:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE),
        createCompanyWorkflowVersionUniversalIdentifier: (0, _uuid.v5)(`createCompanyWorkflowVersionUniversalIdentifier:${workspaceId}`, WORKFLOW_PREFILL_ID_NAMESPACE)
    });
const prefillWorkflows = async (entityManager, workspaceId, schemaName, flatObjectMetadataMaps, flatFieldMetadataMaps, applicationIdParam)=>{
    const { quickLeadWorkflowId, quickLeadWorkflowVersionId, createCompanyWorkflowId, createCompanyWorkflowVersionId, createCompanyAutomatedTriggerId, coreQuickLeadWorkflowId, coreCreateCompanyWorkflowId, coreQuickLeadWorkflowVersionId, coreCreateCompanyWorkflowVersionId, quickLeadWorkflowUniversalIdentifier, createCompanyWorkflowUniversalIdentifier, quickLeadWorkflowVersionUniversalIdentifier, createCompanyWorkflowVersionUniversalIdentifier } = getWorkflowPrefillIds(workspaceId);
    let applicationId = applicationIdParam;
    if (!(0, _utils.isDefined)(applicationId)) {
        const [workspace] = await entityManager.query(`SELECT "workspaceCustomApplicationId" FROM core."workspace" WHERE id = $1`, [
            workspaceId
        ]);
    ...
    const personCreatedByFieldMetadata = Object.values(flatFieldMetadataMaps.byUniversalIdentifier).find((fieldMetadata)=>fieldMetadata?.objectMetadataId === personObjectMetadataId && fieldMetadata?.name === 'createdBy');
    if (!(0, _utils.isDefined)(personCreatedByFieldMetadata)) {
        throw new Error('Person createdBy field metadata not found');
    }
    const personSyncSourceFilter = (0, _buildpersonsyncsourcefilterutil.buildPersonSyncSourceFilter)({
    ...
    await entityManager.createQueryBuilder().insert().into('core.workflow', [
        'id',
        'workspaceId',
        'universalIdentifier',
        'applicationId',
    ...
    const createCompanySteps = JSON.stringify([
        ...
        },
        {
            ...
            valid: false,
            position: {
                x: _workflow.IF_ELSE_BRANCH_POSITION_OFFSETS.IF.x,
                y: 910
            },
            settings: {
                input: {
        ...
        },
        {
            ...
            valid: false,
            position: {
                x: _workflow.IF_ELSE_BRANCH_POSITION_OFFSETS.ELSE.x,
                y: 910
            },
            settings: {
                input: {
    ...
    await entityManager.createQueryBuilder().insert().into('core.workflowVersion', [
        'id',
        'workspaceId',
        'universalIdentifier',
        'applicationId',
