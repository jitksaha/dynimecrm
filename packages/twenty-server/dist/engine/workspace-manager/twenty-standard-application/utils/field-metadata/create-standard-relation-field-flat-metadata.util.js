...
const createStandardRelationFieldFlatMetadata = ({ objectName, workspaceId, context: { fieldName, label, description, icon, targetObjectName, targetFieldName, isNullable = true, isUIEditable = true, isSystemSideEffect = false, defaultValue = null, settings, options: fieldOptions = null, morphId, type, junctionTargetFieldUniversalIdentifier }, standardObjectMetadataRelatedEntityIds, twentyStandardApplicationId, now })=>{
