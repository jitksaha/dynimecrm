...
| Find/replace | script | \`python replace.py pres.pptx '{...}' out.pptx\` |`,
    ...
    roles: (args)=>(0, _createstandardskillflatmetadatautil.createStandardSkillFlatMetadata)({
            ...args,
            context: {
                skillName: 'roles',
                name: 'roles',
                label: 'Roles',
                description: 'Managing roles and permissions: who can read, edit and delete what',
                icon: 'IconLockAccess',
                content: `# Roles Skill
