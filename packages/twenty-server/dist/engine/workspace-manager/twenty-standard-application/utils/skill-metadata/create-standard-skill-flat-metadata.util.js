...
const createStandardSkillFlatMetadata = ({ context: { skillName, name, label, icon, description, content, isCustom, isActive = true }, workspaceId, twentyStandardApplicationId, now })=>{
