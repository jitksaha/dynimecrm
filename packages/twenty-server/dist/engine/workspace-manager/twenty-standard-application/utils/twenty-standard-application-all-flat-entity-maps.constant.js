...
const _buildstandardflatsearchfieldmetadatamapsutil = require("./search-field-metadata/build-standard-flat-search-field-metadata-maps.util");
const _buildstandardflatskillmetadatamapsutil = require("./skill-metadata/build-standard-flat-skill-metadata-maps.util");
const _buildstandardflattimelineactivitytypemapsutil = require("./timeline-activity-type/build-standard-flat-timeline-activity-type-maps.util");
...
const computeTwentyStandardApplicationAllFlatEntityMaps = ({ now, workspaceId, twentyStandardApplicationId })=>{
    ...
    const flatSearchFieldMetadataMaps = (0, _buildstandardflatsearchfieldmetadatamapsutil.buildStandardFlatSearchFieldMetadataMaps)({
        dependencyFlatEntityMaps: {
            flatFieldMetadataMaps,
            flatObjectMetadataMaps
        },
    ...
    const flatTimelineActivityTypeMaps = (0, _buildstandardflattimelineactivitytypemapsutil.buildStandardFlatTimelineActivityTypeMaps)({
        now,
        workspaceId,
        twentyStandardApplicationId
    });
