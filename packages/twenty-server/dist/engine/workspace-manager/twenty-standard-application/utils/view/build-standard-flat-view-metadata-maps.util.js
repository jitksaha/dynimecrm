...
const _computestandardcallrecordingviewsutil = require("./compute-standard-call-recording-views.util");
...
const _computestandardmessagecampaignviewsutil = require("./compute-standard-message-campaign-views.util");
...
const _computestandardmessagelistviewsutil = require("./compute-standard-message-list-views.util");
...
const STANDARD_FLAT_VIEW_METADATA_BUILDERS_BY_OBJECT_NAME = {
    ...
    callRecording: _computestandardcallrecordingviewsutil.computeStandardCallRecordingViews,
    ...
    messageCampaign: _computestandardmessagecampaignviewsutil.computeStandardMessageCampaignViews,
    ...
    messageList: _computestandardmessagelistviewsutil.computeStandardMessageListViews,
