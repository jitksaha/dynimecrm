...
const createStandardViewFlatMetadata = ({ workspaceId, objectName, context: { viewName, name, type, key, position, icon, isCompact = false, isCustom = false, openRecordIn = _types.ViewOpenRecordIn.SIDE_PANEL, kanbanAggregateOperation = null, kanbanAggregateOperationFieldName, mainGroupByFieldName, calendarFieldName, calendarEndFieldName }, standardObjectMetadataRelatedEntityIds, twentyStandardApplicationId, now })=>{
    ...
    const calendarEndFieldMetadataId = calendarEndFieldName ? standardObjectMetadataRelatedEntityIds[objectName].fields[calendarEndFieldName].id : null;
    ...
    const calendarEndFieldMetadataUniversalIdentifier = calendarEndFieldName ? _metadata.STANDARD_OBJECTS[objectName].fields[calendarEndFieldName].universalIdentifier : null;
    return {
        ...
        isActive: true,
        isSystemSideEffect: key === _types.ViewKey.INDEX || type === _types.ViewType.FIELDS_WIDGET,
        overrides: null,
