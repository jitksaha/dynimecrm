...
const addUniversalFlatEntityToUniversalFlatEntityMapsThroughMutationOrThrow = ({ universalFlatEntity, universalFlatEntityMapsToMutate })=>{
    if ((0, _utils.isDefined)(universalFlatEntityMapsToMutate.byUniversalIdentifier[universalFlatEntity.universalIdentifier])) {
        throw new _flatentitymapsexception.FlatEntityMapsException(`addUniversalFlatEntityToUniversalFlatEntityMapsThroughMutationOrThrow: flat entity to add already exists (universalIdentifier: ${universalFlatEntity.universalIdentifier})`, _flatentitymapsexception.FlatEntityMapsExceptionCode.ENTITY_ALREADY_EXISTS, {
            context: {
