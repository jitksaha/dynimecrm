...
const deleteUniversalFlatEntityFromUniversalFlatEntityMapsThroughMutationOrThrow = ({ universalFlatEntityMapsToMutate, universalIdentifierToDelete })=>{
    ...
    if (!(0, _utils.isDefined)(entityToDelete)) {
        throw new _flatentitymapsexception.FlatEntityMapsException(`deleteUniversalFlatEntityFromUniversalFlatEntityMapsThroughMutationOrThrow: entity to delete not found (universalIdentifierToDelete: ${universalIdentifierToDelete})`, _flatentitymapsexception.FlatEntityMapsExceptionCode.ENTITY_NOT_FOUND, {
            context: {
