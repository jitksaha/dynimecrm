...
const resolveUniversalRelationIdentifiersToIds = ({ metadataName, universalForeignKeyValues, flatEntityMaps, preallocatedIdByUniversalIdentifierByMetadataName })=>{
    ...
    for (const relationPropertyName of Object.keys(relationEntries)){
        ...
        const preallocatedId = (0, _utils.isDefined)(universalIdentifierValue) ? preallocatedIdByUniversalIdentifierByMetadataName?.[targetMetadataName]?.[universalIdentifierValue] : undefined;
        if ((0, _utils.isDefined)(preallocatedId)) {
