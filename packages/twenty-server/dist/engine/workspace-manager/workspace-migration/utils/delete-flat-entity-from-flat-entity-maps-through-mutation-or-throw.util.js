...
const deleteFlatEntityFromFlatEntityMapsThroughMutationOrThrow = ({ flatEntityMapsToMutate, entityToDeleteId })=>{
    ...
    if (!(0, _utils.isDefined)(universalIdentifierToDelete)) {
        throw new _flatentitymapsexception.FlatEntityMapsException(`deleteFlatEntityFromFlatEntityMapsThroughMutationOrThrow: entity to delete not found (entityToDeleteId: ${entityToDeleteId})`, _flatentitymapsexception.FlatEntityMapsExceptionCode.ENTITY_NOT_FOUND, {
            context: {
                id: entityToDeleteId,
                operation: 'delete'
            }
