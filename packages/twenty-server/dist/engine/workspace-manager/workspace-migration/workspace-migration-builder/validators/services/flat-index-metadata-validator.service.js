            ...
            flatIndexToValidate.universalFlatIndexFieldMetadatas.forEach((universalFlatIndexField)=>{
                ...
                if (!(0, _utils.isDefined)(relatedFlatField)) {
                    ...
                    if (flatIndexToValidate.isUnique) {
                        ...
                        const isUnindexableRelation = (0, _ismorphorrelationflatfieldmetadatautil.isMorphOrRelationUniversalFlatFieldMetadata)(relatedFlatField) && relatedFlatField.universalSettings?.relationType !== _types.RelationType.MANY_TO_ONE;
