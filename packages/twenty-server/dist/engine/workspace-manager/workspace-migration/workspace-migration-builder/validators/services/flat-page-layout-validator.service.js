...
let FlatPageLayoutValidatorService = class FlatPageLayoutValidatorService {
    validateFlatPageLayoutCreation({ flatEntityToValidate: flatPageLayout, optimisticFlatEntityMapsAndRelatedFlatEntityMaps: { flatObjectMetadataMaps } }) {
        ...
        if ((0, _utils.isDefined)(flatPageLayout.objectMetadataUniversalIdentifier)) {
