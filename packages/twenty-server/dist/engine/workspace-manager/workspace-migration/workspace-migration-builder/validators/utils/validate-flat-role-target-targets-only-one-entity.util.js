...
const validateFlatRoleTargetTargetsOnlyOneEntity = ({ flatRoleTarget })=>{
    ...
    const definedIdentifiersCount = [
        ...
        (0, _utils.isDefined)(flatRoleTarget.agentUniversalIdentifier)
    ...
    if (definedIdentifiersCount !== 1) {
        errors.push({
            ...
            message: _core.i18n._(/*i18n*/ {
                id: "vYrPc5",
                message: "Role target must have exactly one of: apiKeyId, userWorkspaceId, or agentUniversalIdentifier"
            }),
