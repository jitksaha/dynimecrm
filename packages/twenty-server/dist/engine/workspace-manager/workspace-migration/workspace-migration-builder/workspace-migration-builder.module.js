...
const _workspacemigrationtimelineactivitytypeactionsbuilderservice = require("./builders/timeline-activity-type/workspace-migration-timeline-activity-type-actions-builder.service");
const _workspacemigrationsearchfieldmetadataactionsbuilderservice = require("./builders/search-field-metadata/workspace-migration-search-field-metadata-actions.builder.service");
...
WorkspaceMigrationBuilderModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            ...
            _workspacemigrationtimelineactivitytypeactionsbuilderservice.WorkspaceMigrationTimelineActivityTypeActionsBuilderService,
            _workspacemigrationsearchfieldmetadataactionsbuilderservice.WorkspaceMigrationSearchFieldMetadataActionsBuilderService
        ],
        exports: [
            _workspacemigrationviewactionsbuilderservice.WorkspaceMigrationViewActionsBuilderService,
            _workspacemigrationindexactionsbuilderservice.WorkspaceMigrationIndexActionsBuilderService,
