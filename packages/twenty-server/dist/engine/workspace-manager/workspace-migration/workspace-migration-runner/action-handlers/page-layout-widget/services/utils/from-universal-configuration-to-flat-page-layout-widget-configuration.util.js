...
const convertUniversalFilterToChartFilter = ({ filter, flatFieldMetadataMaps })=>{
    ...
    return {
        ...filter,
        recordFilters: filter.recordFilters?.map(({ fieldMetadataUniversalIdentifier, relationTargetFieldMetadataUniversalIdentifier, ...rest })=>({
                ...rest,
                fieldMetadataId: resolveFieldMetadataIdOrThrow({
                    fieldMetadataUniversalIdentifier,
                    flatFieldMetadataMaps
                }),
                ...(0, _utils.isDefined)(relationTargetFieldMetadataUniversalIdentifier) ? {
                    relationTargetFieldMetadataId: resolveFieldMetadataIdOrThrow({
                        fieldMetadataUniversalIdentifier: relationTargetFieldMetadataUniversalIdentifier,
                        flatFieldMetadataMaps
                    })
                } : {}
            }))
...
const fromUniversalConfigurationToFlatPageLayoutWidgetConfiguration = ({ universalConfiguration, flatFieldMetadataMaps, flatFrontComponentMaps, flatViewMaps, flatViewFieldGroupMaps: _flatViewFieldGroupMaps })=>{
    switch(universalConfiguration.configurationType){
        ...
        case _widgetconfigurationtypetype.WidgetConfigurationType.FRONT_COMPONENT:
            {
                const { frontComponentUniversalIdentifier, configurationType, headerCommandMenuItemUniversalIdentifiers } = universalConfiguration;
        ...
        case _widgetconfigurationtypetype.WidgetConfigurationType.FIELD:
            {
                const { fieldMetadataId: fieldMetadataUniversalIdentifier, viewId: viewUniversalIdentifier, nestedRelationFieldMetadataId: nestedRelationFieldMetadataUniversalIdentifier, ...rest } = universalConfiguration;
                const fieldMetadataId = resolveFieldMetadataIdOrThrow({
                    fieldMetadataUniversalIdentifier,
                    flatFieldMetadataMaps
                });
                const nestedRelationFieldMetadataId = (0, _utils.isDefined)(nestedRelationFieldMetadataUniversalIdentifier) ? resolveFieldMetadataIdOrThrow({
                    fieldMetadataUniversalIdentifier: nestedRelationFieldMetadataUniversalIdentifier,
                    flatFieldMetadataMaps
                }) : undefined;
                ...
                return {
                    ...
                    fieldMetadataId,
                    viewId,
                    ...(0, _utils.isDefined)(nestedRelationFieldMetadataId) ? {
