...
const _createtimelineactivitytypeactionhandlerservice = require("./timeline-activity-type/services/create-timeline-activity-type-action-handler.service");
const _deletetimelineactivitytypeactionhandlerservice = require("./timeline-activity-type/services/delete-timeline-activity-type-action-handler.service");
const _updatetimelineactivitytypeactionhandlerservice = require("./timeline-activity-type/services/update-timeline-activity-type-action-handler.service");
const _createsearchfieldmetadataactionhandlerservice = require("./search-field-metadata/services/create-search-field-metadata-action-handler.service");
const _deletesearchfieldmetadataactionhandlerservice = require("./search-field-metadata/services/delete-search-field-metadata-action-handler.service");
const _updatesearchfieldmetadataactionhandlerservice = require("./search-field-metadata/services/update-search-field-metadata-action-handler.service");
...
WorkspaceSchemaMigrationRunnerActionHandlersModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            ...
            _createtimelineactivitytypeactionhandlerservice.CreateTimelineActivityTypeActionHandlerService,
            _updatetimelineactivitytypeactionhandlerservice.UpdateTimelineActivityTypeActionHandlerService,
            _deletetimelineactivitytypeactionhandlerservice.DeleteTimelineActivityTypeActionHandlerService,
            _createsearchfieldmetadataactionhandlerservice.CreateSearchFieldMetadataActionHandlerService,
            _updatesearchfieldmetadataactionhandlerservice.UpdateSearchFieldMetadataActionHandlerService,
            _deletesearchfieldmetadataactionhandlerservice.DeleteSearchFieldMetadataActionHandlerService
        ]
    })
