...
let BaseWorkspaceMigrationRunnerActionHandlerService = class BaseWorkspaceMigrationRunnerActionHandlerService {
    ...
    getAfterCommitSideEffects(_context) {
        return [];
    }
    ...
    async asyncMethodPerformanceMetricWrapper({ label, method }) {
        ...
        const recordActionDuration = (status)=>this.metricsService.recordHistogram({
                key: _metricskeystype.MetricsKeys.WorkspaceMigrationActionDurationMs,
        ...
        this.logger.perfTime('BaseWorkspaceMigrationRunnerActionHandlerService', `${this.actionType}_${this.metadataName} ${label}`);
        try {
            await method();
        } catch (error) {
        ...
        this.logger.perfTimeEnd('BaseWorkspaceMigrationRunnerActionHandlerService', `${this.actionType}_${this.metadataName} ${label}`);
...
], BaseWorkspaceMigrationRunnerActionHandlerService.prototype, "metricsService", void 0);
