...
const _metadatasideeffectmodule = require("../../metadata-modules/metadata-side-effect/metadata-side-effect.module");
...
const _workspacemigrationflatentitymapsservice = require("./services/workspace-migration-flat-entity-maps.service");
...
WorkspaceMigrationModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
            ...
            _metadatasideeffectmodule.MetadataSideEffectModule,
        ...
        providers: [
            ...
            _workspacemigrationflatentitymapsservice.WorkspaceMigrationFlatEntityMapsService
        ],
        exports: [
            _workspacemigrationvalidatebuildandrunservice.WorkspaceMigrationValidateBuildAndRunService,
            _workspacemigrationbuildorchestratorservice.WorkspaceMigrationBuildOrchestratorService
