...
const _tomicrosofteventinpututil = require("../to-microsoft-event-input.util");
const baseInput = {
    title: 'Team Sync',
...
describe('toMicrosoftEventInput', ()=>{
    it('converts the absolute instant to wall-clock in the event time zone (Graph ignores the offset)', ()=>{
        ...
        const event = (0, _tomicrosofteventinpututil.toMicrosoftEventInput)(baseInput);
    ...
    it('keeps the wall-clock unchanged when the event time zone is UTC', ()=>{
        const event = (0, _tomicrosofteventinpututil.toMicrosoftEventInput)({
            ...baseInput,
            timeZone: 'UTC'
        });
...
//# sourceMappingURL=to-microsoft-event-input.util.spec.js.map