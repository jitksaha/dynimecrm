...
const _calendarimporteventsservice = require("./services/calendar-import-events.service");
...
CalendarEventImportManagerModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            ...
            (0, _provideworkspacescopedrepository.provideWorkspaceScopedRepository)(_calendarchannelentity.CalendarChannelEntity),
            ...
            _calendarimporteventsservice.CalendarImportEventsService,
