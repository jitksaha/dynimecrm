...
let CalendarEventsImportCronJob = class CalendarEventsImportCronJob {
        ...
        for (const activeWorkspace of activeWorkspaces){
            try {
                ...
                const updateResult = await this.calendarChannelRepository.createQueryBuilder().update().set({
                    syncStage: _types.CalendarChannelSyncStage.CALENDAR_EVENTS_IMPORT_SCHEDULED,
    ...
    constructor(workspaceRepository, messageQueueService, calendarChannelRepository, exceptionHandlerService){
        this.workspaceRepository = workspaceRepository;
        this.messageQueueService = messageQueueService;
        this.calendarChannelRepository = calendarChannelRepository;
        this.exceptionHandlerService = exceptionHandlerService;
        this.logger = new _common.Logger(CalendarEventsImportCronJob.name);
    }
};
_ts_decorate([
