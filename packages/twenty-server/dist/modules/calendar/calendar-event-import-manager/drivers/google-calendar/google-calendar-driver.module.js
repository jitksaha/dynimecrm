...
const _googlecalendarimporteventsservice = require("./services/google-calendar-import-events.service");
...
GoogleCalendarDriverModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            ...
            _googlecalendarimporteventsservice.GoogleCalendarImportEventsService
        ],
        exports: [
            _googlecalendargeteventsservice.GoogleCalendarGetEventsService,
            _googlecalendarimporteventsservice.GoogleCalendarImportEventsService
