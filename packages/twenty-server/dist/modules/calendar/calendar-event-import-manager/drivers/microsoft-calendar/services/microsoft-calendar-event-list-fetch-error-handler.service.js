...
Object.defineProperty(exports, "MicrosoftCalendarEventListFetchErrorHandler", {
    enumerable: true,
    get: function() {
        return MicrosoftCalendarEventListFetchErrorHandler;
    }
});
...
let MicrosoftCalendarEventListFetchErrorHandler = class MicrosoftCalendarEventListFetchErrorHandler {
    // oxlint-disable-next-line typescript/no-explicit-any
    handleError(error) {
        this.logger.error(`Error fetching calendar event list: ${JSON.stringify(error)}`);
    ...
    constructor(microsoftCalendarNetworkErrorHandler){
        ...
        this.logger = new _common.Logger(MicrosoftCalendarEventListFetchErrorHandler.name);
    }
};
MicrosoftCalendarEventListFetchErrorHandler = _ts_decorate([
...
//# sourceMappingURL=microsoft-calendar-event-list-fetch-error-handler.service.js.map