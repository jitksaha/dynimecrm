...
Object.defineProperty(exports, "CreateWebhookSubscriptionJob", {
    enumerable: true,
    get: function() {
        return CreateWebhookSubscriptionJob;
    }
});
...
let CreateWebhookSubscriptionJob = class CreateWebhookSubscriptionJob {
    async handle(data) {
        const { channelType, channelId, workspaceId } = data;
        switch(channelType){
            case _types.WebhookSubscriptionChannelType.MESSAGING:
                await this.messagingWebhookSubscriptionService.createSubscription(channelId, workspaceId);
                break;
            case _types.WebhookSubscriptionChannelType.CALENDAR:
                await this.calendarWebhookSubscriptionService.createSubscription(channelId, workspaceId);
                break;
        }
    }
...
_ts_decorate([
    (0, _processdecorator.Process)(CreateWebhookSubscriptionJob.name),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
        typeof CreateWebhookSubscriptionJobData === "undefined" ? Object : CreateWebhookSubscriptionJobData
    ]),
    _ts_metadata("design:returntype", Promise)
], CreateWebhookSubscriptionJob.prototype, "handle", null);
CreateWebhookSubscriptionJob = _ts_decorate([
...
//# sourceMappingURL=create-webhook-subscription.job.js.map