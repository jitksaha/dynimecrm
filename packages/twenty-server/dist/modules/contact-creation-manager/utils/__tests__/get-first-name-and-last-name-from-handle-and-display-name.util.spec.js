...
const _getfirstnameandlastnamefromhandleanddisplaynameutil = require("../get-first-name-and-last-name-from-handle-and-display-name.util");
describe('getFirstNameAndLastNameFromHandleAndDisplayName', ()=>{
    const testCases = [
        ...
        {
            title: 'should accept a single-word display name and fall back to handle for last',
            context: {
        ...
        {
            title: 'should fall back to handle when display name contains the address',
            context: {
        ...
        {
            title: 'should fall back to handle for single-token email-as-display-name',
            context: {
        ...
        {
            title: 'should strip ":XXX" group-code suffix from comma-format first name',
            context: {
                handle: 'jane.smith@example.com',
    ...
    test.each(testCases)('$title', ({ context: { handle, displayName, expected } })=>{
        expect((0, _getfirstnameandlastnamefromhandleanddisplaynameutil.getFirstNameAndLastNameFromHandleAndDisplayName)(handle, displayName)).toEqual(expected);
    });
});

//# sourceMappingURL=get-first-name-and-last-name-from-handle-and-display-name.util.spec.js.map