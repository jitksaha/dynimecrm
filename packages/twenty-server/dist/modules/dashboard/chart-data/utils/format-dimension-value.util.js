...
const formatDimensionValue = ({ value, fieldMetadata, dateGranularity, subFieldName, userTimezone, firstDayOfTheWeek, relationLabelByRecordId })=>{
        ...
        case _types.FieldMetadataType.MORPH_RELATION:
            {
                if (!(0, _utils.isDefined)(subFieldName)) {
                    if (!(0, _utils.isDefined)(relationLabelByRecordId)) {
                        return String(value);
                    }
                    return relationLabelByRecordId.get(String(value)) ?? _core.i18n._(/*i18n*/ {
                        id: "Ef7StM",
                        message: "Unknown"
                    });
                }
