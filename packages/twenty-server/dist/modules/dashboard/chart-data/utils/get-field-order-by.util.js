...
const getFieldOrderBy = ({ groupByFieldMetadata, groupBySubFieldName, dateGranularity, direction, flatObjectMetadataMaps, flatFieldMetadataMaps })=>{
    ...
    if ((0, _ismorphorrelationflatfieldmetadatautil.isMorphOrRelationFlatFieldMetadata)(groupByFieldMetadata)) {
        return (0, _getrelationfieldorderbyutil.getRelationFieldOrderBy)({
