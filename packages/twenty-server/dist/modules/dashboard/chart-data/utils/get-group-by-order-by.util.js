...
const getGroupByOrderBy = ({ graphOrderBy, groupByFieldMetadata, groupBySubFieldName, aggregateOperation, aggregateFieldMetadata, dateGranularity, flatObjectMetadataMaps, flatFieldMetadataMaps })=>{
    switch(graphOrderBy){
        case _graphorderbyenum.GraphOrderBy.FIELD_ASC:
        case _graphorderbyenum.GraphOrderBy.FIELD_DESC:
            return (0, _getfieldorderbyutil.getFieldOrderBy)({
                groupByFieldMetadata,
                groupBySubFieldName,
                dateGranularity,
                direction: (0, _maporderbytodirectionutil.mapOrderByToDirection)(graphOrderBy),
