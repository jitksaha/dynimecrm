...
const processTwoDimensionalResults = ({ rawResults, primaryAxisGroupByField, secondaryAxisGroupByField, primaryDateGranularity, primarySubFieldName, secondaryDateGranularity, secondarySubFieldName, userTimezone, firstDayOfTheWeek, primaryRelationLabelResolution, secondaryRelationLabelResolution })=>{
    ...
    for (const result of rawResults){
        ...
        const yFormatted = (0, _formatdimensionvalueutil.formatDimensionValue)({
            ...
            userTimezone,
            firstDayOfTheWeek,
            relationLabelByRecordId: secondaryRelationLabelResolution?.labelByRecordId
        });
