...
let DashboardToolWorkspaceService = class DashboardToolWorkspaceService {
    ...
    constructor(pageLayoutService, pageLayoutTabService, pageLayoutWidgetService, workspaceOrmManager, recordPositionService, applicationService, flatEntityMapsCacheService){
        this.deps = {
            pageLayoutService,
