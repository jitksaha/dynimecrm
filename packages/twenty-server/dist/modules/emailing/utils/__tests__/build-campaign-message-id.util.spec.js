...
const _buildcampaignmessageidutil = require("../build-campaign-message-id.util");
...
describe('buildCampaignMessageId', ()=>{
    it('returns the same id for the same campaign and person', ()=>{
        expect((0, _buildcampaignmessageidutil.buildCampaignMessageId)({
            campaignId: CAMPAIGN_ID,
            personId: PERSON_ID
        })).toBe((0, _buildcampaignmessageidutil.buildCampaignMessageId)({
            campaignId: CAMPAIGN_ID,
            personId: PERSON_ID
        }));
    });
    it('returns a different id for another person in the same campaign', ()=>{
        expect((0, _buildcampaignmessageidutil.buildCampaignMessageId)({
            campaignId: CAMPAIGN_ID,
            personId: PERSON_ID
        })).not.toBe((0, _buildcampaignmessageidutil.buildCampaignMessageId)({
            campaignId: CAMPAIGN_ID,
    ...
    it('is stable across calls so a retried materialization reuses the same message rows', ()=>{
        const ids = Array.from({
            length: 5
        }, ()=>(0, _buildcampaignmessageidutil.buildCampaignMessageId)({
                campaignId: CAMPAIGN_ID,
                personId: PERSON_ID
            }));
...
//# sourceMappingURL=build-campaign-message-id.util.spec.js.map