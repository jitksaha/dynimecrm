...
const _normalizesesoutboundeventutil = require("../normalize-ses-outbound-event.util");
...
describe('normalizeSesOutboundEvent', ()=>{
    ...
    it('should map sending status events to a tenant status', ()=>{
        ...
        expect(event).toEqual({
            ...
            sendingState: {
                workspaceId: WORKSPACE_ID,
                status: _emailingdomaintenantstatustype.EmailingDomainTenantStatus.PAUSED
            }
        });
    });
...
//# sourceMappingURL=normalize-ses-outbound-event.util.spec.js.map