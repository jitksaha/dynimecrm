...
describe('parseWorkspaceIdFromAwsSesResourceArn', ()=>{
    ...
    it.each([
        ...
        expect((0, _parseworkspaceidfromawssesresourcearnutil.parseWorkspaceIdFromAwsSesResourceArn)(arn)).toBe('ws1');
    });
    it('preserves the workspaceId verbatim when it is a UUID', ()=>{
        expect((0, _parseworkspaceidfromawssesresourcearnutil.parseWorkspaceIdFromAwsSesResourceArn)('arn:aws:ses:us-east-1:123456789012:tenant/twenty-workspace-20202020-cb1b-4e35-b50f-2bbd09c3b1ee/9b1deb4d')).toBe('20202020-cb1b-4e35-b50f-2bbd09c3b1ee');
    });
    ...
    it.each([
        ...
        expect((0, _parseworkspaceidfromawssesresourcearnutil.parseWorkspaceIdFromAwsSesResourceArn)(arn)).toBeNull();
    });
});

//# sourceMappingURL=parse-workspace-id-from-aws-ses-resource-arn.util.spec.js.map