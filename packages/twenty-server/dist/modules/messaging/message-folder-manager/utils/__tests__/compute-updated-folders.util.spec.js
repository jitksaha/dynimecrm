...
describe('computeUpdatedFolders', ()=>{
    it('should apply updates and set correct pendingSyncAction', ()=>{
        ...
        expect(result[0].pendingSyncAction).toBe(_types.MessageFolderPendingSyncAction.NONE);
        expect(result[1].pendingSyncAction).toBe(_types.MessageFolderPendingSyncAction.FOLDER_DELETION);
        expect(result[2].name).toBe('Unchanged');
        expect(result[2].pendingSyncAction).toBe(_types.MessageFolderPendingSyncAction.NONE);
    });
