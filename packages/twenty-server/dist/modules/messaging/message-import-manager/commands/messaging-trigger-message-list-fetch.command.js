...
let MessagingTriggerMessageListFetchCommand = class MessagingTriggerMessageListFetchCommand extends _nestcommander.CommandRunner {
    ...
    constructor(workspaceOrmManager, messageChannelRepository, messageQueueService){
        super(), this.workspaceOrmManager = workspaceOrmManager, this.messageChannelRepository = messageChannelRepository, this.messageQueueService = messageQueueService, this.logger = new _common.Logger(MessagingTriggerMessageListFetchCommand.name);
    }
};
_ts_decorate([
