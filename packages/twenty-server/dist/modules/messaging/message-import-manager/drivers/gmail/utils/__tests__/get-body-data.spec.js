...
describe('getBodyData', ()=>{
    it('should return undefined when payload is missing', ()=>{
        expect((0, _getbodydatautil.getBodyData)({})).toBeUndefined();
    });
    it('should return undefined when no text parts exist', ()=>{
        ...
        expect((0, _getbodydatautil.getBodyData)(message)).toBeUndefined();
    });
        ...
        const message = makeMessage({
            ...
            parts: [
                ...
                },
                {
                    mimeType: 'text/html',
                    body: {
                        data: encode('<p>Hello</p>'),
                        size: 12
                    }
                }
            ]
        });
        const result = (0, _getbodydatautil.getBodyData)(message);
...
//# sourceMappingURL=get-body-data.spec.js.map