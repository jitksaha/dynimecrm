...
const _resolvereceivedatutil = require("../resolve-received-at.util");
...
describe('resolveReceivedAt', ()=>{
    it('uses the Date header when it is valid', ()=>{
        const result = (0, _resolvereceivedatutil.resolveReceivedAt)({
...
//# sourceMappingURL=resolve-received-at.util.spec.js.map