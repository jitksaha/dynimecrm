...
const _messagingimportfoldermessagesservice = require("./services/messaging-import-folder-messages.service");
...
MessagingImportManagerModule = _ts_decorate([
    (0, _common.Module)({
        ...
        providers: [
            ...
            (0, _provideworkspacescopedrepository.provideWorkspaceScopedRepository)(_messagechannelentity.MessageChannelEntity),
            ...
            _messagingimportfoldermessagesservice.MessagingImportFolderMessagesService,
