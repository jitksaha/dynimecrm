...
let MessagingDeleteFolderMessagesService = class MessagingDeleteFolderMessagesService {
    async deleteFolderMessages(workspaceId, messageChannel, messageFolder) {
        ...
        await this.workspaceOrmManager.executeInWorkspaceContext(async ()=>{
            const messageFolderAssociationRepository = this.workspaceOrmManager.getRepository('messageChannelMessageAssociationMessageFolder');
    ...
    constructor(messagingMessageCleanerService, workspaceOrmManager){
