...
const _extractmessagebodytextutil = require("../extract-message-body-text.util");
...
`,
        ...
        const result = (0, _extractmessagebodytextutil.extractMessageBodyText)({
            text: parsed.text,
            html: parsed.html
        });
...
Developer Support`);
  ...
  ::-webkit-scrollbar-thumb:hover {
    ...
    it('should preserve percent sequences instead of URI-decoding the body', ()=>{
        ...
        expect(result).toBe('See https://example.com/path%2Fto%2Ffile and a 100%20 budget cut');
    });
});

//# sourceMappingURL=extract-message-body-text.util.spec.js.map