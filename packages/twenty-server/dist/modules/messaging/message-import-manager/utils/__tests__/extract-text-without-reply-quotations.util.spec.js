...
describe('extractTextWithoutReplyQuotations', ()=>{
    it('should keep the new reply and drop the quoted history', ()=>{
        const result = (0, _extracttextwithoutreplyquotationsutil.extractTextWithoutReplyQuotations)('New reply here.\n\nOn Mon, someone wrote:\n> old line');
    ...
    it('should drop a nested "On <date>, <name> wrote:" thread without quote markers', ()=>{
        const result = (0, _extracttextwithoutreplyquotationsutil.extractTextWithoutReplyQuotations)('Latest answer.\n\nOn 24 Jun 2024, at 15:14, Omar M <omar@x.com> wrote:\nprevious question\nsecond previous line');
    ...
    it('should keep the full body when the message is entirely quoted (forward) and would otherwise be emptied', ()=>{
        ...
        const forwardedBody = '> quoted line one\n> quoted line two\n> quoted line three';
        expect((0, _extracttextwithoutreplyquotationsutil.extractTextWithoutReplyQuotations)(forwardedBody)).toBe(forwardedBody);
    });
});

//# sourceMappingURL=extract-text-without-reply-quotations.util.spec.js.map