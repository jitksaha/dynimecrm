...
describe('isUnsubscribeEmail', ()=>{
    it.each([
        ...
        expect((0, _isunsubscribeemailutil.isUnsubscribeEmail)(email)).toBe(true);
    });
    it.each([
        'jane@unsubtle.com',
        'optometry@acme.com',
        ...
        expect((0, _isunsubscribeemailutil.isUnsubscribeEmail)(email)).toBe(false);
    });
});

//# sourceMappingURL=is-unsubscribe-email.util.spec.js.map