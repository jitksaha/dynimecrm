...
describe('safeParseEmailAddresses', ()=>{
    ...
    it('should flatten RFC 5322 address groups into their members', ()=>{
        ...
        expect((0, _safeparseemailaddressesutil.safeParseEmailAddresses)('Team: alice@example.com, Bob <bob@example.com>;, carol@example.com')).toEqual([
            {
                address: 'alice@example.com',
                name: ''
            },
    ...
    it('should return nothing for an empty group', ()=>{
        expect((0, _safeparseemailaddressesutil.safeParseEmailAddresses)('undisclosed-recipients:;')).toEqual([]);
    });
