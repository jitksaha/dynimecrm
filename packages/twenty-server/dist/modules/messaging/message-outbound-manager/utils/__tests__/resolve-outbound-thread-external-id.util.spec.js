...
describe('resolveOutboundThreadExternalId', ()=>{
    it("should prefer the provider's thread id when present", ()=>{
        const result = (0, _resolveoutboundthreadexternalidutil.resolveOutboundThreadExternalId)({
            sendResult: {
...
//# sourceMappingURL=resolve-outbound-thread-external-id.util.spec.js.map