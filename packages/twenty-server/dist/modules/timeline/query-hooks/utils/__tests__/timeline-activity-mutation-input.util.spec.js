...
const _timelineactivitymutationinpututil = require("../timeline-activity-mutation-input.util");
...
describe('timeline activity mutation input', ()=>{
    it('replaces client-provided snapshots with the resolved snapshot', ()=>{
        expect((0, _timelineactivitymutationinpututil.stampTimelineActivityTypeSnapshots)({
            records: [
                {
    ...
    it('rejects missing targets and partial linked records', ()=>{
        expect(()=>(0, _timelineactivitymutationinpututil.assertTimelineActivityCreationInputIsValid)({
                records: [
                    {
                        timelineActivityTypeId: TYPE_ID
                    }
    ...
    it('rejects changing either immutable type field after creation', ()=>{
        expect(()=>(0, _timelineactivitymutationinpututil.assertTimelineActivityTypeIsNotUpdated)([
                {
                    timelineActivityTypeSnapshot: snapshot
                }
...
//# sourceMappingURL=timeline-activity-mutation-input.util.spec.js.map