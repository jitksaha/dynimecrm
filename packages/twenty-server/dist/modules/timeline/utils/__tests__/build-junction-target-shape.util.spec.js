...
const _buildjunctiontargetshapeutil = require("../build-junction-target-shape.util");
...
const buildShape = (relationFlatFieldMetadata)=>(0, _buildjunctiontargetshapeutil.buildJunctionTargetShape)({
        relationFlatFieldMetadata: relationFlatFieldMetadata,
...
describe('buildJunctionTargetShape', ()=>{
    ...
    it('should build a single join column for a non morph junction target', ()=>{
        const shape = (0, _buildjunctiontargetshapeutil.buildJunctionTargetShape)({
...
//# sourceMappingURL=build-junction-target-shape.util.spec.js.map