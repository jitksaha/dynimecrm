...
Object.defineProperty(exports, "WorkflowDestroyManyPostQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowDestroyManyPostQueryHook;
    }
});
...
let WorkflowDestroyManyPostQueryHook = class WorkflowDestroyManyPostQueryHook {
    async execute(authContext, _objectName, payload) {
        ...
        await this.workflowVersionCoreSyncService.deleteCoreVersionsByWorkflowIds(workspace.id, payload.map((workflow)=>workflow.id));
    }
    constructor(workflowVersionCoreSyncService){
        this.workflowVersionCoreSyncService = workflowVersionCoreSyncService;
    }
};
WorkflowDestroyManyPostQueryHook = _ts_decorate([
...
//# sourceMappingURL=workflow-destroy-many.post-query.hook.js.map