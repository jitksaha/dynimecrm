...
Object.defineProperty(exports, "WorkflowVersionDeleteOnePostQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowVersionDeleteOnePostQueryHook;
    }
});
...
let WorkflowVersionDeleteOnePostQueryHook = class WorkflowVersionDeleteOnePostQueryHook {
    async execute(authContext, _objectName, payload) {
        ...
        await this.workflowVersionCoreSyncService.deleteCoreVersionsByWorkspaceVersionIds(workspace.id, payload.map((workflowVersion)=>workflowVersion.id));
    }
    constructor(workflowVersionCoreSyncService){
        this.workflowVersionCoreSyncService = workflowVersionCoreSyncService;
    }
};
WorkflowVersionDeleteOnePostQueryHook = _ts_decorate([
...
//# sourceMappingURL=workflow-version-delete-one.post-query.hook.js.map