...
Object.defineProperty(exports, "WorkflowVersionDestroyManyPreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowVersionDestroyManyPreQueryHook;
    }
});
...
let WorkflowVersionDestroyManyPreQueryHook = class WorkflowVersionDestroyManyPreQueryHook {
...
WorkflowVersionDestroyManyPreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflowVersion.destroyMany`)
], WorkflowVersionDestroyManyPreQueryHook);

//# sourceMappingURL=workflow-version-destroy-many.pre-query.hook.js.map