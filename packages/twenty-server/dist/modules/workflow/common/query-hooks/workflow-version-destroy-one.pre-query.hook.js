...
Object.defineProperty(exports, "WorkflowVersionDestroyOnePreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowVersionDestroyOnePreQueryHook;
    }
});
...
let WorkflowVersionDestroyOnePreQueryHook = class WorkflowVersionDestroyOnePreQueryHook {
...
WorkflowVersionDestroyOnePreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflowVersion.destroyOne`)
], WorkflowVersionDestroyOnePreQueryHook);

//# sourceMappingURL=workflow-version-destroy-one.pre-query.hook.js.map