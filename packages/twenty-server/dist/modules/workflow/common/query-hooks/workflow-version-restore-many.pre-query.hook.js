...
Object.defineProperty(exports, "WorkflowVersionRestoreManyPreQueryHook", {
    enumerable: true,
    get: function() {
        return WorkflowVersionRestoreManyPreQueryHook;
    }
});
...
let WorkflowVersionRestoreManyPreQueryHook = class WorkflowVersionRestoreManyPreQueryHook {
...
WorkflowVersionRestoreManyPreQueryHook = _ts_decorate([
    (0, _workspacequeryhookdecorator.WorkspaceQueryHook)(`workflowVersion.restoreMany`)
], WorkflowVersionRestoreManyPreQueryHook);

//# sourceMappingURL=workflow-version-restore-many.pre-query.hook.js.map