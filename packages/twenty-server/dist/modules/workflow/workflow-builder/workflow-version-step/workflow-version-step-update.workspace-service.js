...
const _getnextstepidsforsteptypechangeutil = require("./utils/get-next-step-ids-for-step-type-change.util");
    ...
    async updateWorkflowVersionStepType({ existingStep, newStep, workspaceId, workflowVersionId }) {
        ...
        const updatedStep = await this.workflowSchemaWorkspaceService.enrichOutputSchema({
            step: {
                ...builtStep,
                id: existingStep.id,
                nextStepIds: (0, _getnextstepidsforsteptypechangeutil.getNextStepIdsForStepTypeChange)({
                    existingStep,
                    builtStep
                }),
