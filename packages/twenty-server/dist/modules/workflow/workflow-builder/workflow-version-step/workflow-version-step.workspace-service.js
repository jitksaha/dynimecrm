...
let WorkflowVersionStepWorkspaceService = class WorkflowVersionStepWorkspaceService {
    ...
    async updateWorkflowVersionTrigger({ workspaceId, workflowVersionId, trigger }) {
    ...
    constructor(workflowVersionStepCreationWorkspaceService, workflowVersionStepUpdateWorkspaceService, workflowVersionStepDeletionWorkspaceService, workflowVersionStepHelpersWorkspaceService){
