...
let UpsertRecordWorkflowAction = class UpsertRecordWorkflowAction {
    async execute({ currentStepId, steps, context, runInfo }) {
        ...
        const { formattedRecord: formattedObjectRecord } = (0, _formatworkflowrecordrelationfieldsutil.formatWorkflowRecordRelationFields)(workflowActionInput.objectRecord, objectMetadataInfo);
