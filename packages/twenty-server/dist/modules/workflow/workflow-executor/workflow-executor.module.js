...
const _createcalendareventactionmodule = require("./workflow-actions/create-calendar-event/create-calendar-event-action.module");
...
const _httprequestactionmodule = require("./workflow-actions/http-request/http-request-action.module");
...
const _mailsenderactionmodule = require("./workflow-actions/mail-sender/mail-sender-action.module");
...
WorkflowExecutorModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
            ...
            _httprequestactionmodule.HttpRequestActionModule,
            _mailsenderactionmodule.MailSenderActionModule,
            _createcalendareventactionmodule.CreateCalendarEventActionModule,
