    ...
    async run(_passedParam, options) {
        ...
        for(let i = 0; i < workspaceIds.length; i++){
            ...
            try {
                ...
                await this.workflowHandleStaledRunsWorkspaceService.handleStuckStoppingRunsForWorkspace(workspaceId);
                await this.workflowHandleStaledRunsWorkspaceService.handleStuckRunningRunsForWorkspace(workspaceId);
            } catch (error) {
