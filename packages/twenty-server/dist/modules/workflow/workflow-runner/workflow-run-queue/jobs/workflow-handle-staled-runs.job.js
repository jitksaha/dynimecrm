...
let WorkflowHandleStaledRunsJob = class WorkflowHandleStaledRunsJob {
    async handle({ workspaceId }) {
        await Promise.all([
            this.workflowHandleStaledRunsWorkspaceService.handleStaledRunsForWorkspace(workspaceId),
            this.workflowHandleStaledRunsWorkspaceService.handleStuckStoppingRunsForWorkspace(workspaceId),
            this.workflowHandleStaledRunsWorkspaceService.handleStuckRunningRunsForWorkspace(workspaceId)
        ]);
    }
