...
let WorkflowThrottlingWorkspaceService = class WorkflowThrottlingWorkspaceService {
    ...
    async recomputeWorkflowRunNotStartedCount(workspaceId) {
        ...
        const currentlyNotStartedWorkflowRunCount = await this.workspaceOrmManager.executeInWorkspaceContext(async ()=>{
    ...
    constructor(cacheStorage, workspaceOrmManager, throttlerService, twentyConfigService){
