...
const _getworkflowruntool = require("../get-workflow-run.tool");
...
describe('get_workflow_run tool', ()=>{
    it('should pass rolePermissionConfig to getRepository', async ()=>{
        ...
        const tool = (0, _getworkflowruntool.createGetWorkflowRunTool)(deps, context);
        await tool.execute({
...
//# sourceMappingURL=get-workflow-run.tool.spec.js.map