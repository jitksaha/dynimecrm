...
const _workflowvalidationmodule = require("../workflow-builder/workflow-validation/workflow-validation.module");
...
WorkflowToolsModule = _ts_decorate([
    ...
    (0, _common.Module)({
        imports: [
            ...
            _workflowvalidationmodule.WorkflowValidationModule,
