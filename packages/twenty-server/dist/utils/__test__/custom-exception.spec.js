...
describe('CustomException', ()=>{
    it('should assign the statusCode option when provided', ()=>{
        const exception = new _customexception.UnknownException('Not found', 'NOT_FOUND', {
    ...
    it('should leave statusCode undefined when the option is omitted', ()=>{
        const exception = new _customexception.UnknownException('Boom', 'INTERNAL_SERVER_ERROR', {
            userFriendlyMessage: /*i18n*/ {
                id: "rEDXNA",
                message: "Boom"
            }
