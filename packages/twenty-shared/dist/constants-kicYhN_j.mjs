import { A as e, Lt as t, i as n } from "./types-BVPyJxl2.mjs";
//#region src/constants/AccountTypes.ts
var r = [
	"IMAP",
	"SMTP",
	"CALDAV"
], i = ["firstName", "lastName"], a = "default-fast-model", o = "default-smart-model", s = 1e4, c = /* @__PURE__ */ function(e) {
	return e[e.SYSTEM = 7] = "SYSTEM", e[e.SUNDAY = 0] = "SUNDAY", e[e.MONDAY = 1] = "MONDAY", e[e.SATURDAY = 6] = "SATURDAY", e;
}({}), l = "command-menu-item-confirmation-modal-result", u = {
	[t.CURRENCY]: {
	...
	return e.AED = "AED", e.AFN = "AFN", e.ALL = "ALL", e.AMD = "AMD", e.ANG = "ANG", e.AOA = "AOA", e.ARS = "ARS", e.AUD = "AUD", e.AWG = "AWG", e.AZN = "AZN", e.BAM = "BAM", e.BBD = "BBD", e.BDT = "BDT", e.BGN = "BGN", e.BHD = "BHD", e.BIF = "BIF", e.BMD = "BMD", e.BND = "BND", e.BOB = "BOB", e.BRL = "BRL", e.BSD = "BSD", e.BTN = "BTN", e.BWP = "BWP", e.BYN = "BYN", e.BZD = "BZD", e.CAD = "CAD", e.CDF = "CDF", e.CHF = "CHF", e.CLP = "CLP", e.CLF = "CLF", e.CNY = "CNY", e.COP = "COP", e.CRC = "CRC", e.CUP = "CUP", e.CVE = "CVE", e.CZK = "CZK", e.DJF = "DJF", e.DKK = "DKK", e.DOP = "DOP", e.DZD = "DZD", e.EGP = "EGP", e.ERN = "ERN", e.ETB = "ETB", e.EUR = "EUR", e.FJD = "FJD", e.FKP = "FKP", e.GBP = "GBP", e.GEL = "GEL", e.GHS = "GHS", e.GIP = "GIP", e.GMD = "GMD", e.GNF = "GNF", e.GTQ = "GTQ", e.GYD = "GYD", e.HKD = "HKD", e.HNL = "HNL", e.HTG = "HTG", e.HUF = "HUF", e.IDR = "IDR", e.ILS = "ILS", e.INR = "INR", e.IQD = "IQD", e.IRR = "IRR", e.ISK = "ISK", e.JMD = "JMD", e.JOD = "JOD", e.JPY = "JPY", e.KES = "KES", e.KGS = "KGS", e.KHR = "KHR", e.KMF = "KMF", e.KPW = "KPW", e.KRW = "KRW", e.KWD = "KWD", e.KYD = "KYD", e.KZT = "KZT", e.LAK = "LAK", e.LBP = "LBP", e.LKR = "LKR", e.LRD = "LRD", e.LSL = "LSL", e.LYD = "LYD", e.MAD = "MAD", e.MDL = "MDL", e.MGA = "MGA", e.MKD = "MKD", e.MMK = "MMK", e.MNT = "MNT", e.MOP = "MOP", e.MRU = "MRU", e.MUR = "MUR", e.MVR = "MVR", e.MWK = "MWK", e.MXN = "MXN", e.MYR = "MYR", e.MZN = "MZN", e.NAD = "NAD", e.NGN = "NGN", e.NIO = "NIO", e.NOK = "NOK", e.NPR = "NPR", e.NZD = "NZD", e.OMR = "OMR", e.PAB = "PAB", e.PEN = "PEN", e.PGK = "PGK", e.PHP = "PHP", e.PKR = "PKR", e.PLN = "PLN", e.PYG = "PYG", e.QAR = "QAR", e.RON = "RON", e.RSD = "RSD", e.RUB = "RUB", e.RWF = "RWF", e.SAR = "SAR", e.SBD = "SBD", e.SCR = "SCR", e.SDG = "SDG", e.SEK = "SEK", e.SGD = "SGD", e.SHP = "SHP", e.SLE = "SLE", e.SOS = "SOS", e.SRD = "SRD", e.SSP = "SSP", e.STN = "STN", e.SVC = "SVC", e.SYP = "SYP", e.SZL = "SZL", e.THB = "THB", e.TJS = "TJS", e.TMT = "TMT", e.TND = "TND", e.TOP = "TOP", e.TRY = "TRY", e.TTD = "TTD", e.TWD = "TWD", e.TZS = "TZS", e.UAH = "UAH", e.UGX = "UGX", e.USD = "USD", e.UYU = "UYU", e.UZS = "UZS", e.VES = "VES", e.VND = "VND", e.VUV = "VUV", e.WST = "WST", e.XCD = "XCD", e.XOF = "XOF", e.YER = "YER", e.ZAR = "ZAR", e.ZMW = "ZMW", e.ZWG = "ZWG", e;
}({}), f = {
...
}, v = "https://docs.twenty.com", y = "en", b = {
	...
	DEVELOPERS_EXTEND_APPS_DATA_TIMELINE_ACTIVITY_TYPES: "/developers/extend/apps/data/timeline-activity-types",
	...
	DEVELOPERS_EXTEND_APPS_LOGIC_BACKGROUND_JOBS: "/developers/extend/apps/logic/background-jobs",
	DEVELOPERS_EXTEND_APPS_LOGIC_CONNECTIONS: "/developers/extend/apps/logic/connections",
	DEVELOPERS_EXTEND_APPS_LOGIC_KEY_VALUE_STORE: "/developers/extend/apps/logic/key-value-store",
	...
	USER_GUIDE_SETTINGS_CAPABILITIES_COMMUNITY_SETTINGS: "/user-guide/settings/capabilities/community-settings",
...
}, x = b.GETTING_STARTED_INTRODUCTION, S = [
	"en",
	"fr",
	"ar",
	"cs",
	...
	t.FILES,
	t.POSITION
]), k = "FIELD_RESTRICTED_ADDITIONAL_PERMISSIONS_REQUIRED", A = {
	[t.ACTOR]: "IconSettings",
	[t.ADDRESS]: "IconMap",
	[t.ARRAY]: "IconBrackets",
	[t.BOOLEAN]: "IconToggleLeft",
	[t.CURRENCY]: "IconCurrencyDollar",
	[t.DATE]: "IconCalendarEvent",
	[t.DATE_TIME]: "IconCalendarTime",
	[t.EMAILS]: "IconMail",
	[t.FILES]: "IconFile",
	[t.FULL_NAME]: "IconUser",
	[t.LINKS]: "IconLink",
	[t.MORPH_RELATION]: "IconRelationOneToMany",
	[t.MULTI_SELECT]: "IconTags",
	[t.NUMBER]: "IconNumbers",
	[t.NUMERIC]: "IconNumbers",
	[t.PHONES]: "IconPhone",
	[t.POSITION]: "IconArrowsSort",
	[t.RATING]: "IconStar",
	[t.RAW_JSON]: "IconJson",
	[t.RELATION]: "IconRelationOneToMany",
	[t.RICH_TEXT]: "IconBlockquote",
	[t.SELECT]: "IconTag",
	[t.TEXT]: "IconAbc",
	[t.TS_VECTOR]: "IconSearch",
	[t.UUID]: "IconId"
}, j = 60, M = new Set([
	t.TS_VECTOR,
	t.ARRAY,
...
}, Z = /* @__PURE__ */ "about.admin.africa.al.america.api.app.asia.assets.au.audio.auth.az.ba.be.bg.billing.blog.ca.careers.cdn.ch.chat.community.companies.config.contact.cy.cz.dash.dashboard.db.de.demo.dev.developer.dk.docs.ee.es.eu.europe.events.favicon.feedback.fi.files.forum.fr.gr.help.hr.hu.image.images.inbound.is.it.jobs.legal.login.logs.london.lt.lv.mail.main.me.media.merch.metrics.mk.new-york.news.next.nl.no.north-africa.north-america.nz.oceania.otel-collector.paris.partners.partnership.partnerships.payment.pl.privacy.production.pt.register.ro.rs.ru.san-francisco.se.settings.shop.si.signin.signup.sk.south-africa.south-america.staging.storage.store.support.t.telemetry.terms.test.testing.tr.trust.ua.uk.us.video.www.za".split("."), Q = [
	"person",
	"company",
	"opportunity",
	"note",
	"task"
], $ = /^(?!api-)[a-z0-9](?:[a-z0-9-]{0,28}[a-z0-9])?$/, te = {
...
}, ne = "https://twenty-companies.com", re = "https://twenty-icons.com", ie = [
	"Smaller",
	"Default",
	"Large",
	"Larger"
	...
	[n.TABLE]: "IconTable",
	[n.KANBAN]: "IconLayoutKanban",
	[n.CALENDAR]: "IconCalendar",
	[n.LIST]: "IconList",
	[n.FIELDS_WIDGET]: "IconListDetails",
	[n.TABLE_WIDGET]: "IconTable",
	[n.KANBAN_WIDGET]: "IconLayoutKanban",
	[n.LIST_WIDGET]: "IconList",
	[n.CALENDAR_WIDGET]: "IconCalendar"
};
//#endregion
export { c as $, j as A, x as B, L as C, N as D, P as E, E as F, g as G, y as H, T as I, p as J, h as K, w as L, k as M, O as N, ee as O, D as P, l as Q, C as R, R as S, F as T, v as U, b as V, _ as W, d as X, f as Y, u as Z, U as _, ne as a, B as b, Q as c, Y as d, s as et, J as f, W as g, G as h, re as i, r as it, A as j, M as k, Z as l, K as m, ae as n, a as nt, te as o, q as p, m as q, ie as r, i as rt, $ as s, oe as t, o as tt, X as u, H as v, I as w, z as x, V as y, S as z };
