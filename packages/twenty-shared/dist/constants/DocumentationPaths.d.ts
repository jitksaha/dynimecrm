export declare const DOCUMENTATION_PATHS: {
    ...
    readonly DEVELOPERS_EXTEND_APPS_DATA_SYSTEM_FIELDS: "/developers/extend/apps/data/system-fields";
    readonly DEVELOPERS_EXTEND_APPS_DATA_TIMELINE_ACTIVITY_TYPES: "/developers/extend/apps/data/timeline-activity-types";
    ...
    readonly DEVELOPERS_EXTEND_APPS_LOGIC_BACKGROUND_JOBS: "/developers/extend/apps/logic/background-jobs";
    readonly DEVELOPERS_EXTEND_APPS_LOGIC_CONNECTIONS: "/developers/extend/apps/logic/connections";
    readonly DEVELOPERS_EXTEND_APPS_LOGIC_KEY_VALUE_STORE: "/developers/extend/apps/logic/key-value-store";
    ...
    readonly DEVELOPERS_EXTEND_APPS_OPERATIONS_SYNC_AND_RECOVERY: "/developers/extend/apps/operations/sync-and-recovery";
    readonly DEVELOPERS_EXTEND_APPS_OPERATIONS_TESTING: "/developers/extend/apps/operations/testing";
    readonly DEVELOPERS_EXTEND_APPS_TRANSLATIONS_OVERVIEW: "/developers/extend/apps/translations/overview";
    readonly DEVELOPERS_EXTEND_APPS_TUTORIALS_DOCUMENT_GENERATOR_AI_AGENT: "/developers/extend/apps/tutorials/document-generator/ai-agent";
    readonly DEVELOPERS_EXTEND_APPS_TUTORIALS_DOCUMENT_GENERATOR_BUILDING_THE_UI: "/developers/extend/apps/tutorials/document-generator/building-the-ui";
    readonly DEVELOPERS_EXTEND_APPS_TUTORIALS_DOCUMENT_GENERATOR_DATA_MODEL: "/developers/extend/apps/tutorials/document-generator/data-model";
    readonly DEVELOPERS_EXTEND_APPS_TUTORIALS_DOCUMENT_GENERATOR_GENERATING_DOCUMENTS: "/developers/extend/apps/tutorials/document-generator/generating-documents";
    readonly DEVELOPERS_EXTEND_APPS_TUTORIALS_DOCUMENT_GENERATOR_HTTP_ROUTES: "/developers/extend/apps/tutorials/document-generator/http-routes";
    readonly DEVELOPERS_EXTEND_APPS_TUTORIALS_DOCUMENT_GENERATOR_OVERVIEW: "/developers/extend/apps/tutorials/document-generator/overview";
    readonly DEVELOPERS_EXTEND_APPS_TUTORIALS_DOCUMENT_GENERATOR_PUBLISHING: "/developers/extend/apps/tutorials/document-generator/publishing";
    ...
    readonly USER_GUIDE_LEGAL_HOW_TOS_LEGAL_FAQ: "/user-guide/legal/how-tos/legal-faq";
    readonly USER_GUIDE_LEGAL_OVERVIEW: "/user-guide/legal/overview";
    ...
    readonly USER_GUIDE_SETTINGS_CAPABILITIES_COMMUNITY_SETTINGS: "/user-guide/settings/capabilities/community-settings";
