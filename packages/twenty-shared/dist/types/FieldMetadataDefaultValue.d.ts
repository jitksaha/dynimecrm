...
export declare const FIELD_METADATA_TYPES_WITHOUT_DEFAULT_VALUE: [FieldMetadataType.RELATION, FieldMetadataType.MORPH_RELATION, FieldMetadataType.FILES, FieldMetadataType.TS_VECTOR];
export declare const isFieldMetadataTypeWithDefaultValue: (type: FieldMetadataType) => boolean;
