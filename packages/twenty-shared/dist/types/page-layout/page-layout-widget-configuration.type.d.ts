...
export type PageLayoutWidgetConfiguration = AggregateChartConfiguration | PieChartConfiguration | BarChartConfiguration | LineChartConfiguration | ViewConfiguration | RecordTableConfiguration | FieldConfiguration | FieldsConfiguration | FormFieldConfiguration | FieldRichTextConfiguration | StandaloneRichTextConfiguration | IframeConfiguration | FrontComponentConfiguration | TimelineConfiguration | TasksConfiguration | NotesConfiguration | FilesConfiguration | EmailsConfiguration | CalendarConfiguration | WorkflowConfiguration | WorkflowVersionConfiguration | WorkflowRunConfiguration | EmailThreadConfiguration | MessageCampaignBodyConfiguration | MessageCampaignDetailsConfiguration | CallRecordingSummaryConfiguration | CallRecordingTranscriptConfiguration;
export {};
