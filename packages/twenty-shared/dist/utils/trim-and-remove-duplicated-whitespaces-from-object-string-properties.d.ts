...
export declare const trimAndRemoveDuplicatedWhitespacesFromObjectStringProperties: <T, TKeys extends StringPropertyKeys<T>[], TExtract extends boolean = false>(obj: T, keys: TKeys, extractKeys?: TExtract | undefined) => TExtract extends true ? { [P in TKeys[number]]: T[P]; } : T;
export {};
