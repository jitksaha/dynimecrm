...
import { type BaseOutputSchemaV2, type Leaf, type Node } from './base-output-schema.type';
...
export type RecordFieldNodeValue = RecordOutputSchemaV2 | Record<string, RecordFieldLeaf>;
...
export type OutputSchemaV2 = BaseOutputSchemaV2 | CodeOutputSchema | FindRecordsOutputSchema | FormOutputSchema | RecordOutputSchemaV2 | ManualTriggerOutputSchema | IteratorOutputSchema;
...
//# sourceMappingURL=output-schema.type.d.ts.map